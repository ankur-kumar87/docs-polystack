...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
  <div>
    End-to-end deployment of Polystack with XDEPLOY — from first login after XOS installation to a live multi-node production cluster running Ironcore, Software-Defined-Storage, and XMS. Covers activation, host setup, Software-Defined-Storage storage, cluster configuration, load balancer, monitoring, advanced features, cluster licensing, and the full Operations workflow.
