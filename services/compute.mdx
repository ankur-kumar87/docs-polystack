...
<Note>
  Compute is included in [Ironcore](/products/ironcore), [XPCI](/products/xpci), and [XHCI](/products/xhci). See product pages on [polystack.tech](https://polystack.tech/ironcore) for specifications and datasheets.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Hypervisor (KVM)" icon="cpu" href="/services/compute/hypervisor" color="#bf9667">
...
<CardGroup cols={3}>
  <Card title="Bare-Metal Hypervisor" icon="cpu" href="/services/compute/hypervisor" color="#bf9667">
  ...
  <Card title="Live vCPU/RAM Scaling" icon="move-vertical" href="/services/compute/live-resize" color="#bf9667">
...
<CardGroup cols={3}>
  ...
  <Card title="Image Service" icon="disc" href="/services/images/index" color="#bf9667">
  ...
  <Card title="Load Balancer" icon="combine" href="/services/load-balancer" color="#bf9667">
