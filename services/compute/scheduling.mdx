...
description: "Configure host aggregates and availability zones in Polystack Compute to control how instances are placed across the cluster."
...
The Polystack Compute scheduler determines which physical host runs each new instance.
