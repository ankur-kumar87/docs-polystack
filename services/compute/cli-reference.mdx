...
<CardGroup cols={2}>
  <Card title="Launch Instance Guide" href="/services/compute/launch-instance" color="#bf9667">
    Step-by-step walkthrough for launching your first instance
  </Card>
  <Card title="Block Storage CLI" href="/services/storage/cli-reference" color="#bf9667">
