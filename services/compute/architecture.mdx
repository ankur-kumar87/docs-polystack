...
graph TD
    ...
    style PL fill:#d7b98e,color:#fff
    style CON fill:#d7b98e,color:#fff
```
...
|---------|---------------|-----------|
| `nova-api` | Running, listening on `:8774` | XDeploy / Ironcore |
| `placement-api` | Running, listening on `:8778` | XDeploy / Ironcore |
| `nova-scheduler` | Running | XDeploy / Ironcore |
| `nova-conductor` | Running | XDeploy / Ironcore |
| `nova-compute` | Running on every hypervisor node | XDeploy / Ironcore |
| `nova-novncproxy` | Running, listening on `:6080` | XDeploy / Ironcore |
...
<Steps titleSize="h3">
  ...
  <Step title="Placement selects resources" icon="target">
  ...
  <Step title="Conductor orchestrates the build" icon="git-merge">
