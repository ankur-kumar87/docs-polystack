...
description: "Perform hard or soft reboots on Xloud Compute instances using the Dashboard or CLI. Understand the difference between reboot types and when to use each."
