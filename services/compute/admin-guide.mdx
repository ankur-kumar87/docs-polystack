...
<CardGroup cols={4}>
  <Card title="Architecture" icon="workflow" href="/services/compute/architecture" color="#bf9667">
  ...
  <Card title="Console Access" icon="monitor" href="/services/compute/console-access" color="#bf9667">
  ...
  <Card title="Advanced" icon="cpu" href="/services/compute/advanced-features" color="#bf9667">
