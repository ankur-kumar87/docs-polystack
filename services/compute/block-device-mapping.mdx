...
description: "Control how storage volumes are presented to Xloud Compute instances at launch. Configure boot-from-volume, system disks, data disks, and CD-ROM devices."
