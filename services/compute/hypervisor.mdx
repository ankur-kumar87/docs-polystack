...
<CardGroup cols={2}>
  <Card title="Advanced Features" icon="wand" href="/services/compute/advanced-features" color="#bf9667">
  ...
  <Card title="Compute Architecture" icon="layers" href="/services/compute/architecture" color="#bf9667">
