...
<Note>
  **Prerequisites**
  - Administrator access to the Polystack platform and XDeploy
...
The storage backend is configured per compute node in the Nova configuration, managed by XDeploy via the ironcore-ansible deployment playbooks.
...
<Info>**Polystack-Developed** — Heterogeneous hardware support is a core capability of Ironcore / XPCI.</Info>
