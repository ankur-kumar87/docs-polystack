...
description: "Configure the native hypervisor driver for Xloud Compute. Covers image formats, CPU modes, backing storage, nested virtualization, and performance tuning."
...
```yaml title="/etc/xavs/globals.d/_50_compute.yml"
