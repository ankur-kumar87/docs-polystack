...
Launching an instance creates a virtual machine on an Polystack Compute host. The Dashboard
...
<CardGroup cols={2}>
  <Card title="Windows VM from ISO" icon="monitor" href="/services/compute/windows-vm-guide" color="#bf9667">
    ISO boot with VirtIO driver injection, Sysprep, and image creation
  </Card>
  <Card title="Linux VM from ISO" icon="terminal" href="/services/compute/linux-vm-guide" color="#bf9667">
...
<iframe
  ...
  title="How to Create a Virtual Machine on Polystack"
    ...
    <Steps titleSize="h3">
      ...
      <Step title="Step 1 — Base Config">
        ...
        **Start Source** (required) — Select the boot source type:
        ...
        | Source | Description |
        |--------|-------------|
        | **Image** | Boot from an OS image in the Polystack Image Service |
      ...
      <Step title="Step 3 — System Config">
        ...
        **Advanced Options** — Click to expand additional settings:
        ...
        | **Virtual TPM** | All users | Attach a virtual TPM device (requires Polystack KMS). See [vTPM and Secure Boot](/services/compute/vtpm-secure-boot) |
        | **Secure Boot** | All users | Require UEFI Secure Boot (requires Polystack KMS). See [vTPM and Secure Boot](/services/compute/vtpm-secure-boot) |
...
<CardGroup cols={2}>
  <Card title="Security Groups" href="/services/compute/security-groups" color="#bf9667">
