...
description: "Boot an Polystack Compute instance from a rescue image to recover from OS boot failures, corrupted filesystems, or lost SSH access."
...
<Warning>
  ...
  available in the Polystack Dashboard. Use the CLI commands below to enter and exit
  rescue mode.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="Reboot an Instance" href="/services/compute/reboot-instance" color="#bf9667">
