...
<CardGroup cols={2}>
  ...
  <Card title="Create an Instance" href="/services/compute/launch-instance" color="#bf9667">
    Launch instances from the 4-step wizard
  </Card>
  <Card title="Image Management" href="/services/images/upload-image" color="#bf9667">
