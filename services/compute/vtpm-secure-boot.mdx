...
<CardGroup cols={2}>
  ...
  <Card title="Measured Boot" icon="list-checks" color="#bf9667">
    The vTPM records a cryptographic measurement of the boot chain, enabling remote
    attestation of the guest's boot integrity.
  </Card>
  <Card title="Windows 11 Hardware Requirements" icon="monitor" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="Windows 11 hardened VM" icon="monitor" color="#bf9667">
