...
<Steps titleSize="h3">
  ...
  <Step title="Complete Base Config and Network Config" icon="network-wired">
    Pick the image or boot source, flavor, and networks in the first two wizard steps.
  </Step>
  <Step title="Open Advanced Options in System Config" icon="gear">
...
<Steps titleSize="h3">
  <Step title="Tick Virtual TPM" icon="shield-halved">
  ...
  <Step title="Choose a vTPM Model" icon="microchip">
...
<CardGroup cols={2}>
  <Card title="Windows 11 hardened VM" icon="desktop" color="#bf9667">
    vTPM 2.0 (tpm-crb) + Secure Boot (Required). BitLocker auto-seals keys to the vTPM
    and Secure Boot blocks unsigned drivers.
  </Card>
  <Card title="Hardened Linux VM" icon="terminal" color="#bf9667">
...
<AccordionGroup>
  <Accordion title="The vTPM or Secure Boot checkbox is grayed out" icon="circle-xmark">
    Polystack KMS is not enabled on the cluster. Ask your administrator to enable the Key
    Manager service in the deployment console, then refresh the wizard.
  </Accordion>
  <Accordion title="Instance fails to start with Secure Boot = Required" icon="triangle-exclamation">
  ...
  <Accordion title="Windows 11 installer does not detect a TPM" icon="desktop">
...
<CardGroup cols={3}>
  <Card title="Create Instance" href="/services/compute/launch-instance" color="#bf9667">
