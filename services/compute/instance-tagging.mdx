...
| **Dashboard metadata editor** | Custom metadata editing is handled through supported Dashboard and API workflows. Use the CLI metadata commands when you need direct key-value updates for automation. |
