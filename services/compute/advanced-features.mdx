...
<AccordionGroup>
  <Accordion title="NUMA-Aware Scheduling" icon="cpu">
    ...
    <Info>**Polystack-Developed** — NUMA-aware scheduling with per-flavor granularity is developed by Polystack and ships with Ironcore / XPCI.</Info>
  ...
  <Accordion title="CPU Pinning" icon="microchip">
    ...
    <Info>**Polystack-Developed** — CPU pinning with mixed-policy support is developed by Polystack and ships with Ironcore / XPCI.</Info>
  ...
  <Accordion title="CPU Feature Masking (EVC Equivalent)" icon="shield">
    ...
    <Info>**Polystack-Developed** — Per-flavor CPU feature masking is developed by Polystack and ships with Ironcore / XPCI.</Info>
  ...
  <Accordion title="Huge Pages" icon="layers">
    ...
    <Info>**Polystack-Developed** — Huge page management with per-flavor page size selection is developed by Polystack and ships with Ironcore / XPCI.</Info>
  ...
  <Accordion title="vTPM (Virtual Trusted Platform Module)" icon="shield-check">
    ...
    <Info>**Polystack-Developed** — vTPM with live migration support and Dashboard integration is developed by Polystack and ships with Ironcore / XPCI.</Info>
