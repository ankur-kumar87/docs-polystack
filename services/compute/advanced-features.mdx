...
<AccordionGroup>
  <Accordion title="NUMA-Aware Scheduling" icon="microchip">
  ...
  <Accordion title="Huge Pages" icon="layer-group">
    <Badge color="purple" size="sm" shape="pill" icon="building">Enterprise</Badge>
  ...
  <Accordion title="GPU Passthrough" icon="desktop">
    <Badge color="purple" size="sm" shape="pill" icon="building">Enterprise</Badge>
  ...
  <Accordion title="vTPM (Virtual Trusted Platform Module)" icon="shield-halved">
    <Badge color="purple" size="sm" shape="pill" icon="building">Enterprise</Badge>
  ...
  <Accordion title="PCI Passthrough" icon="microchip">
    <Badge color="purple" size="sm" shape="pill" icon="building">Enterprise</Badge>
