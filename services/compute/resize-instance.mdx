...
description: "Change the flavor of an Polystack Compute instance to adjust vCPU, RAM, and disk allocation. Confirm or revert the resize before it is finalized."
