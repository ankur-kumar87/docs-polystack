...
<CardGroup cols={4}>
  ...
  <Card title="Server Groups" icon="group" href="/services/compute/server-groups" color="#bf9667">
  ...
  <Card title="Resize Instance" icon="move-vertical" href="/services/compute/resize-instance" color="#bf9667">
    Change vCPU, RAM, and disk
  </Card>
  <Card title="Reboot Instance" icon="refresh-cw" href="/services/compute/reboot-instance" color="#bf9667">
    Soft and hard reboot
  </Card>
  <Card title="Rescue Instance" icon="life-buoy" href="/services/compute/rescue-instance" color="#bf9667">
