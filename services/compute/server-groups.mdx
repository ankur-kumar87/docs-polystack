---
title: "Server Groups"
description: "Control instance placement across physical hosts using affinity and anti-affinity policies. Create and manage server groups in the Polystack Dashboard or CLI."
