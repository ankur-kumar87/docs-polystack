---
title: "XIMP Administration Guide"
description: "Deploy and configure XIMP — agents, metric endpoints, log collection, alert channels, and retention policies."
...
<CardGroup cols={4}>
  ...
  <Card title="Software-Defined-Storage Admin Guide" icon="database" href="/services/sds/admin-guide" color="#197560">
    Integrate Software-Defined-Storage storage metrics with XIMP for unified storage observability
  </Card>
