...
<Card title="Monitoring — Infrastructure Monitoring Platform" icon="up-right-from-square" href="https://polystack.tech/polystack-support-services/" color="#bf9667" horizontal>
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="gear" href="/services/monitoring/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Network Traffic Monitoring" icon="network-wired" href="/services/monitoring/user-guide/network-monitoring" color="#bf9667">
  ...
  <Card title="DDoS Prevention" icon="shield-halved" href="/services/monitoring/admin-guide/ddos-protection" color="#bf9667">
  ...
  <Card title="Configuration Management" icon="gear" href="/services/monitoring/admin-guide/agent-config" color="#bf9667">
