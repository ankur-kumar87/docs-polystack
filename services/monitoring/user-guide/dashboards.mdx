---
title: "Dashboards"
description: "Navigate Monitoring infrastructure dashboards, create custom views, and drill down into compute, storage, and network metrics."
sidebarTitle: "Dashboards"
---

## Overview

Monitoring dashboards provide real-time and historical views of your environment across
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Select a dashboard" icon="table-cells-large">
      ...
      <Step title="Filter and zoom" icon="magnifying-glass-plus">
  ...
  <Tab title="CLI" icon="terminal">
    ...
    monitoring dashboard export --name "Infrastructure Overview" \
...
<Steps titleSize="h3">
  ...
  <Step title="Add panels" icon="table-cells-large">
  ...
  <Step title="Configure the metric query" icon="magnifying-glass">
    ...
    ```
    polystack_compute_cpu_utilization{host="compute-node-01"}
    ```
...
<CardGroup cols={2}>
  <Card title="Group by context" icon="table-cells" color="#bf9667">
  ...
  <Card title="Use template variables" icon="code" color="#bf9667">
  ...
  <Card title="Set alert thresholds visually" icon="bell" color="#bf9667">
  ...
  <Card title="Link to related dashboards" icon="link" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Network Monitoring" href="/services/monitoring/user-guide/network-monitoring" color="#bf9667">
