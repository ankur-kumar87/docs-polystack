---
title: "Security"
description: "Secure XIMP with agent token management, dashboard role-based access control via Polystack identity, and TLS certificate lifecycle management."
...
XIMP dashboard access is controlled through Polystack identity roles. Assign roles
...
<CardGroup cols={2}>
  ...
  <Card title="Polystack Identity" href="/services/identity/admin-guide" color="#197560">
    Manage the Polystack identity roles used for XIMP access control
  </Card>
</CardGroup>
