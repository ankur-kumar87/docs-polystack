...
<Steps titleSize="h3">
  ...
  <Step title="Configure custom scrape targets" icon="gear">
...
<Steps titleSize="h3">
  ...
  <Step title="Configure the agent" icon="file-lines">
...
<Tabs>
  ...
  <Tab title="Token Rotation" icon="arrows-rotate">
    ...
    <Steps titleSize="h3">
      ...
      <Step title="Update agent configuration" icon="gear">
