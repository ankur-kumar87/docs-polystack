...
description: "Deploy Monitoring monitoring agents via XDeploy or manually, configure custom scrape targets, and manage per-node agent authentication tokens."
...
<Steps titleSize="h3">
  <Step title="Register the node" icon="plus">
    ...
    IP, hostname, and role. XDeploy installs and configures the Monitoring agent as part
