---
title: "XIMP Architecture"
description: "Understand the XIMP service layers — collection, storage, and serving — and how metrics, logs, and flow data move from infrastructure sources to operators."
  ...
  <Tab title="XDeploy" icon="server">
    ...
    <Steps titleSize="h3">
      ...
      <Step title="Save and deploy" icon="rocket">
        ...
        <Check>XIMP monitoring stack is deployed and collecting data.</Check>
      </Step>
    </Steps>
  </Tab>
...
<Tabs>
  <Tab title="Standard (Single-Node XIMP)" icon="server">
  ...
  <Tab title="Scaled (Multi-Node XIMP)" icon="layers">
