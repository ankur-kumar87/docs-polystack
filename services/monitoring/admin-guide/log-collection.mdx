...
<Tabs>
  ...
  <Tab title="Configuration File" icon="file-lines">
...
<Steps titleSize="h3">
  <Step title="Configure rsyslog forwarding" icon="paper-plane">
  ...
  <Step title="Reload rsyslog" icon="arrows-rotate">
...
<CardGroup cols={2}>
  ...
  <Card title="Log Analytics (User Guide)" href="/services/monitoring/user-guide/log-analytics" color="#bf9667">
