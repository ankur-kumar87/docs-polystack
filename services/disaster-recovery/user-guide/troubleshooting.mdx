...
description: "Diagnose common Disaster Recovery user-facing issues — replication lag exceeding RPO targets, failover stuck states, and DR test instance access problems."
sidebarTitle: "Troubleshooting"
---

## Overview

This page covers the most common issues encountered when using Disaster Recovery — from replication
...
<Note>
  **Prerequisites**
  - An active Polystack account with project access and Disaster Recovery plan access
  - For site connectivity and replication configuration issues, contact your administrator. Your administrator can configure this through the deployment console.
</Note>
...
<AccordionGroup>
  <Accordion title="Replication lag exceeding RPO target" icon="clock">
    ...
    **Resolution**:
    - Increase network bandwidth allocation for replication traffic (contact your administrator). Your administrator can configure this through the deployment console.
  ...
  <Accordion title="DR test instances not accessible" icon="network-wired">
  ...
  <Accordion title="Failback synchronization not completing" icon="arrows-rotate">
...
Contact your DR administrator or [support@polystack.tech](mailto:support@polystack.tech) if any of the following persist. Your administrator can configure this through the deployment console.
...
<CardGroup cols={2}>
  <Card title="Disaster Recovery Admin — Troubleshooting" href="/services/disaster-recovery/admin-guide/troubleshooting" color="#bf9667">
