---
title: "Failback"
description: "Return XDR-protected workloads to the primary site after it has been restored — reverse replication, synchronize changed data, and execute failback."
