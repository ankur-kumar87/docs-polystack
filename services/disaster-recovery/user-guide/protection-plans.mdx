...
<Note>
  **Prerequisites**
  ...
  - At least one DR site registered and connected (contact your administrator if no DR site is configured). Your administrator can configure this through the deployment console.
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Define plan settings" icon="gear">
        | Field | Description |
        |-------|-------------|
