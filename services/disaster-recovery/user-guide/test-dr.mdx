---
title: "DR Testing"
description: "Validate Disaster Recovery protection plans with isolated DR tests — confirm recovery procedures and measure actual RTO without impacting production workloads."
...
confirm recovery procedures and measure actual RTO. Polystack recommends running DR tests
at least quarterly.
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Start a DR test" icon="flask">
      ...
      <Step title="End the test" icon="circle-xmark">
...
After each DR test, Disaster Recovery generates a report including:
...
<Warning>
  Monitoring can alert when a DR test has not been run within the configured interval.
