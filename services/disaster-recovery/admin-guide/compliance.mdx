...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    ...
    <Steps titleSize="h3">
      <Step title="Select report type" icon="file-lines">
      ...
      <Step title="Set parameters" icon="gear">
...
<AccordionGroup>
  <Accordion title="Executive summary" icon="file-lines">
  ...
  <Accordion title="Per-plan RTO compliance" icon="bolt">
...
<CardGroup cols={2}>
  ...
  <Card title="Security" href="/services/disaster-recovery/admin-guide/security" color="#bf9667">
