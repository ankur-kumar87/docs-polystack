...
<Note>
  **Prerequisites**
  ...
  - Disaster Recovery agent deployed on both sites via the deployment console
</Note>
  ...
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Register the primary site" icon="server">
        Log in to **the deployment console** (`https://connect.<your-domain>`) and navigate to
      ...
      <Step title="Configure link settings" icon="gear">
