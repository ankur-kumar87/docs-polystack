---
title: "Storage Types"
description: "Understand block, object, and shared file storage in Software-Defined-Storage — capabilities, use cases, and how to choose the right interface for your workload."
sidebarTitle: "Storage Types"
---

## Overview

Software-Defined-Storage exposes three distinct storage interfaces from a single distributed platform.
...
<Tabs>
  <Tab title="Overview" icon="hard-drive">
    Block storage volumes attach to Polystack Compute instances as persistent disks. Volumes
    ...
    **Capabilities:**
    ...
    | Encryption | At-rest encryption via the Polystack Key Management service |
  ...
  <Tab title="Best For" icon="circle-check">
    ...
    See the [Polystack Block Storage guide](/services/storage/user-guide) for complete
...
<Tabs>
  <Tab title="Overview" icon="box">
    ...
    **Capabilities:**
    ...
    <Note>
      Access credentials for object storage are separate from your Polystack Dashboard
...
<AccordionGroup>
  ...
  <Accordion title="I need to store backups at low cost" icon="box-archive">
...
<CardGroup cols={2}>
  <Card title="Access Methods" href="/services/sds/user-guide/access-methods" color="#bf9667">
  ...
  <Card title="Block Storage User Guide" href="/services/storage/user-guide" color="#bf9667">
