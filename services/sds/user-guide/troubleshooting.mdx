...
description: "Diagnose and resolve common Software-Defined-Storage user-facing issues — stuck volumes, snapshot failures, object storage performance, and access errors."
sidebarTitle: "Troubleshooting"
---

## Overview

This page covers common issues encountered when using Software-Defined-Storage block, object, and shared
file storage — including diagnosis steps and resolutions for each scenario.

<Note>
  **Prerequisites**
  - Access to the Polystack Dashboard and CLI (`openstack` CLI authenticated)
  - For advanced diagnostics, contact your storage administrator. Your administrator can configure this through the deployment console.
</Note>
...
<AccordionGroup>
  <Accordion title="Volume stuck in 'creating' status" icon="clock">
    ...
    **Diagnosis**:
    ...
    | Cause | Resolution |
    |-------|-----------|
    | Insufficient capacity in the target pool | Choose a different volume type or contact your administrator to expand capacity. Your administrator can configure this through the deployment console. |
    | Volume type references an unavailable backend | Try a different volume type; contact your administrator if the issue persists. Your administrator can configure this through the deployment console. |
    | Storage service temporarily unhealthy | Wait 2–3 minutes and check status again; contact your administrator if it persists beyond 5 minutes. Your administrator can configure this through the deployment console. |
    ...
    more than 5 minutes. Your administrator can configure this through the deployment console.
  </Accordion>
  ...
  <Accordion title="Snapshot creation fails" icon="circle-xmark">
    ...
    **Resolution**:
    - For quota exceeded: contact your administrator to increase the snapshot quota. Your administrator can configure this through the deployment console.
  ...
  <Accordion title="NFS mount fails or is inaccessible" icon="network-wired">
...
Contact [support@polystack.tech](mailto:support@polystack.tech) if:
...
<CardGroup cols={2}>
  <Card title="Software-Defined-Storage Admin Troubleshooting" href="/services/sds/admin-guide/troubleshooting" color="#bf9667">
  ...
  <Card title="Snapshots" href="/services/sds/user-guide/snapshots" color="#bf9667">
    Best practices for creating consistent snapshots to minimize recovery risk
  </Card>
  <Card title="Support" href="mailto:support@polystack.tech" color="#bf9667">
    Contact Polystack support for issues that require cluster-level investigation
  </Card>
</CardGroup>
