...
description: "Configure replication and erasure coding in Software-Defined-Storage to protect your data against hardware failures with the right balance of durability and storage efficiency."
sidebarTitle: "Data Protection"
---

## Overview

Software-Defined-Storage offers two data protection strategies: **replication** and **erasure coding**.
...
<Note>
  **Prerequisites**
  ...
  - Contact your storage administrator to provision erasure-coded pools — they are
    configured at the cluster level by an administrator. Your administrator can configure this through the deployment console.
</Note>
...
<Tabs>
  <Tab title="How It Works" icon="copy">
    When data is written to a replicated pool, Software-Defined-Storage simultaneously writes it to the
  ...
  <Tab title="Selecting a Replicated Pool" icon="gauge">
    Volume types in the Polystack Dashboard map to specific storage pools. Replicated pools
    ...
    <Steps titleSize="h3">
      <Step title="Check available volume types" icon="list">
        ...
        by replicated pools versus erasure-coded pools. Your administrator can configure this through the deployment console.
      </Step>
...
<Tabs>
  ...
  <Tab title="Using Erasure-Coded Pools" icon="gauge">
    ...
    <Note>
      ...
      pool for your project. Your administrator can configure this through the deployment console. See the [Software-Defined-Storage Admin Guide](/services/sds/admin-guide/pool-management)
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    ...
    storage administrator to confirm the protection scheme for that pool type. Your administrator can configure this through the deployment console.
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Production Workloads" icon="server" color="#bf9667">
  ...
  <Card title="Backup & Archive" icon="archive" color="#bf9667">
  ...
  <Card title="Development Environments" icon="flask-conical" color="#bf9667">
  ...
  <Card title="Pre-Maintenance Snapshots" icon="copy" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Storage Tiers" href="/services/sds/user-guide/performance" color="#bf9667">
    Route workloads to NVMe, SSD, or HDD tiers based on access patterns
  </Card>
  <Card title="Software-Defined-Storage Admin — Pool Management" href="/services/sds/admin-guide/pool-management" color="#bf9667">
    Create and configure replicated and erasure-coded pools (administrator)
  </Card>
  <Card title="Software-Defined-Storage Admin — CRUSH Maps" href="/services/sds/admin-guide/crush-maps" color="#bf9667">
