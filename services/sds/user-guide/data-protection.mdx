...
<CardGroup cols={2}>
  ...
  <Card title="Software-Defined-Storage Admin — Pool Management" href="/services/sds/admin-guide/pool-management" color="#197560">
    Create and configure replicated and erasure-coded pools (administrator)
  </Card>
  <Card title="Software-Defined-Storage Admin — CRUSH Maps" href="/services/sds/admin-guide/crush-maps" color="#197560">
