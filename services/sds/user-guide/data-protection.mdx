...
<Tabs>
  ...
  <Tab title="Using Erasure-Coded Pools" icon="gauge">
    ...
    <Note>
      ...
      pool for your project. Your administrator can configure this through [XDeploy](/deployment). See the [Software-Defined-Storage Admin Guide](/services/sds/admin-guide/pool-management)
