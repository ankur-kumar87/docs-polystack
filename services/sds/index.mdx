...
<Card title="Software-Defined-Storage — Software-Defined Storage" icon="external-link" href="https://polystack.tech/ceph" color="#bf9667" horizontal>
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="settings" href="/services/sds/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="Unified Storage" icon="layers" href="/services/sds/user-guide/storage-types" color="#bf9667">
    Single platform delivers block, object, and file storage — eliminating the need for
    separate storage appliances per protocol.
  </Card>
  <Card title="Self-Healing Architecture" icon="shield-check" href="/services/sds/admin-guide/architecture" color="#bf9667">
  ...
  <Card title="Petabyte Scalability" icon="trending-up" href="/services/sds/admin-guide/capacity-planning" color="#bf9667">
  ...
  <Card title="Performance Optimization" icon="zap" href="/services/sds/user-guide/performance" color="#bf9667">
  ...
  <Card title="Multi-Protocol Access" icon="network" href="/services/sds/user-guide/access-methods" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Backup & Recovery" icon="rotate-ccw" color="#bf9667">
