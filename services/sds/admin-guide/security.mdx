...
<Tabs>
  <Tab title="Enable Encryption" icon="lock">
    ...
    <Steps titleSize="h3">
      <Step title="Configure encryption before deployment" icon="gear">
...
<Tabs>
  ...
  <Tab title="Key Rotation" icon="arrows-rotate">
...
<Tabs>
  <Tab title="Recommended Setup" icon="network-wired">
  ...
  <Tab title="Verify Network Config" icon="gear">
