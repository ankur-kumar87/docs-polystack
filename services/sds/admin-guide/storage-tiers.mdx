...
<Tip>
  **XDeploy GUI** — Storage tier detection, CRUSH rule creation, and pool configuration can be performed through the [Software-Defined-Storage Storage](/deployment/software-defined-storage) interface under the **Storage Tiers** tab. Click **Detect Tiers** to automatically discover device classes. No manual file editing required.
</Tip>
