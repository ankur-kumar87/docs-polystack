---
title: "CRUSH Maps"
description: "Configure the XSDS CRUSH map to define failure domains, device class rules, and data placement topology across nodes, racks, and data center rooms."
