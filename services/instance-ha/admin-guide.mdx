...
<CardGroup cols={4}>
  <Card title="Architecture" icon="layer-group" href="/services/instance-ha/admin-guide/architecture" color="#bf9667">
    Component diagram, service roles, and the detection-to-recovery data flow.
  </Card>
  <Card title="Failover Segments" icon="shield-halved" href="/services/instance-ha/admin-guide/failover-segments" color="#bf9667">
  ...
  <Card title="Instance Monitors" icon="desktop" href="/services/instance-ha/admin-guide/instance-monitors" color="#bf9667">
  ...
  <Card title="Engine Configuration" icon="gear" href="/services/instance-ha/admin-guide/engine-config" color="#bf9667">
