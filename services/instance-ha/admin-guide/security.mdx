...
<AccordionGroup>
  ...
  <Accordion title="Minimum required roles for service account" icon="shield-halved">
...
<AccordionGroup>
  ...
  <Accordion title="Disable debug logging in production" icon="eye-slash">
...
<CardGroup cols={2}>
  <Card title="IPMI Network Isolation" icon="network-wired" color="#bf9667">
  ...
  <Card title="API Endpoint Protection" icon="shield-halved" color="#bf9667">
