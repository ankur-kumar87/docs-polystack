...
description: "Configure Xloud Instance HA instance-level monitors — guest heartbeat detection, notification types, and per-instance fault handling independent of host state."
...
```bash title="Verify XAVS Guest Agent inside instance (SSH)"
