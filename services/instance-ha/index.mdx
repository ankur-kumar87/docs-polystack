...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="shield-halved" href="/services/instance-ha/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Network Resilience" icon="network-wired" color="#bf9667">
  ...
  <Card title="Rolling Upgrades with Rollback" icon="circle-arrow-up" color="#bf9667">
...
<CardGroup cols={3}>
  ...
  <Card title="Resource Optimizer" icon="arrow-trend-up" href="/services/optimization/index" color="#bf9667">
