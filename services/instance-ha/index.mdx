...
description: "Automatically detect and recover failed instances and compute hosts with Xloud Instance HA — zero-touch failover for mission-critical workloads."
icon: "heart-pulse"
