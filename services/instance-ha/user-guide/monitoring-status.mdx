...
description: "Track Instance HA recovery events, review notification history, manage hosts, and monitor VM evacuations from the Polystack Dashboard and CLI."
sidebarTitle: "Monitoring Status"
---

## Overview

Polystack Instance HA logs every fault detection and recovery event as a notification.
...
<CardGroup cols={2}>
  <Card title="Troubleshooting" href="/services/instance-ha/user-guide/troubleshooting" color="#bf9667">
  ...
  <Card title="Protection Segments" href="/services/instance-ha/user-guide/protection-segments" color="#bf9667">
    Create segments and manage host registrations
  </Card>
  <Card title="Instance HA Admin Guide" href="/services/instance-ha/admin-guide" color="#bf9667">
