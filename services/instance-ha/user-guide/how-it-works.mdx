...
<CardGroup cols={2}>
  <Card title="Host Monitor" color="#bf9667">
  ...
  <Card title="Notification Engine" color="#bf9667">
  ...
  <Card title="Recovery Engine" color="#bf9667">
  ...
  <Card title="Compute API" color="#bf9667">
...
<Info>
  ...
  administrator can configure this through the deployment console.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Instance HA Overview" href="/services/instance-ha/index" color="#bf9667">
