...
<CardGroup cols={4}>
  <Card title="Failover Segment" icon="shield-check" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Instance HA Admin Guide" icon="shield-check" href="/services/instance-ha/admin-guide" color="#bf9667">
