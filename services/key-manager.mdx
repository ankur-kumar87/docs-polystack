...
<Card title="Polystack Key Manager — Enterprise KMS" icon="lock" href="https://polystack.tech/ironflex-hci/" color="#bf9667" horizontal>
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="shield-halved" href="/services/key-manager/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Access Control Lists" icon="list-check" href="/services/key-manager/acl" color="#bf9667">
