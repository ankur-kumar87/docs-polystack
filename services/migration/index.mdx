...
description: "Agentless workload migration from VMware vSphere and ESXi to Polystack with incremental sync, automatic driver injection, and minimal cutover downtime."
icon: "truck"
...
and standalone ESXi hosts into Polystack with no agent installed in the source guest.
...
<Card title="XMS — Migration Suite" icon="external-link" href="https://polystack.tech/contact" color="#197560" horizontal>
  Contact the Polystack team for XMS planning, sizing, and licensing
</Card>
...
<CardGroup cols={2}>
  <Card title="User Guide" icon="book-open" href="/services/migration/user-guide" color="#197560">
    ...
    execute cold or warm migrations from the Polystack Dashboard.
  </Card>
  ...
  <Card title="Block Storage" icon="hard-drive" href="/services/storage/index" color="#197560">
    Target volumes are provisioned through Polystack Block Storage — review volume
...
<Info>**Polystack-Developed** — XMS is developed by Polystack and ships with Ironcore / XPCI.</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Incremental Cutover" icon="zap">
    ...
    delta and switches the workload to Polystack.
  </Card>
...
<Steps titleSize="h3">
  ...
  <Step title="Submit migration" icon="play">
    ...
    Polystack project, network, and volume type, and queue the job.
  </Step>
  ...
  <Step title="Guest conversion and boot" icon="cpu">
    ...
    migrated instance in the target Polystack project.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="BIOS and UEFI Guests" icon="shield">
    Both BIOS and UEFI guests migrate to Polystack without firmware-specific
...
<CardGroup cols={3}>
  <Card title="Polystack Compute" icon="server" href="/services/compute" color="#197560">
    Migrated workloads run as Polystack Compute instances with full lifecycle and
    scaling features.
  </Card>
  <Card title="Block Storage" icon="hard-drive" href="/services/storage/index" color="#197560">
    Target disks land as Polystack Block Storage volumes. Choose volume types to
