...
description: "Register a VMware source, discover workloads, run preflight checks, execute cold and warm migrations, and finish with cutover using the Xloud Dashboard."
