...
description: "How the Xloud Migration Suite is structured — control plane, migration workers, disk transport libraries, and integration with Xloud platform services."
