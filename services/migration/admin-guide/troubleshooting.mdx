...
<Steps titleSize="h3">
  <Step title="Platform identity" icon="key">
    Confirm the Polystack Identity service is reachable and responding to token
  ...
  <Accordion title="Migration panel is slow or times out" icon="gauge">
    ...
    **Fix**:
    ...
    - Check identity service latency — a slow identity service impacts
      every Polystack UI, not just XMS
  </Accordion>
...
When escalating an incident to Polystack support, collect:
