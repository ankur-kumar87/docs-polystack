...
description: "Add a vCenter Server or standalone ESXi host to XMS as a migration source so its virtual machines become discoverable from the Polystack Dashboard."
...
<Note>
  **Prerequisites**
  - An active Polystack account with permission to use the Migration panel
  ...
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Open the Migration panel" icon="truck">
        Sign in to the **Polystack Dashboard** and navigate to **Migration → Environments**.
