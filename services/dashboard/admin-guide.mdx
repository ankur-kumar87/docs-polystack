...
<CardGroup cols={2}>
  ...
  <Card title="Flavors" icon="cpu" href="/services/compute/flavors" color="#bf9667">
  ...
  <Card title="Host Aggregates" icon="layers" href="/services/compute/scheduling" color="#bf9667">
...
<Tabs>
  <Tab title="Web Console" icon="settings">
    <Steps titleSize="h3">
