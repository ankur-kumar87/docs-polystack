...
<Note>
  The Dashboard is included with [Ironcore](/products/ironcore), powered by [VM2Cloud](https://vm2cloud.com/). Access it at `https://connect.<your-domain>` after deployment.
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Network Topology" icon="network-wired" href="/services/networking/create-network" color="#bf9667">
    Visual topology map and full SDN configuration
  </Card>
  <Card title="Image Library" icon="compact-disc" href="/services/images/upload-image" color="#bf9667">
...
<p style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.75rem' }}>Advanced Features</p>
