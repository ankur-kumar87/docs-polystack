...
<CardGroup cols={2}>
  ...
  <Card title="Networks" icon="network" href="/services/networking/create-network" color="#bf9667">
    Create networks, subnets, routers, and configure floating IPs
  </Card>
  <Card title="Images" icon="disc" href="/services/images/upload-image" color="#bf9667">
  ...
  <Card title="Global Search" icon="search" href="/services/dashboard/user-guide/global-search" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Networking User Guide" icon="network" href="/services/networking/user-guide" color="#bf9667">
