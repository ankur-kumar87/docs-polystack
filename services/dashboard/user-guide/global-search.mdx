---
title: "Global Search"
description: "Find any instance, volume, network, image, or other Xloud resource from a single search bar in the Dashboard — fuzzy match, keyboard-driven, with recent searches and quick actions."
