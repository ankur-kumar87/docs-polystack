...
<CardGroup cols={2}>
  <Card title="Object Storage User Guide" href="/services/object-storage/user-guide" color="#bf9667">
    Complete object storage management reference
  </Card>
  <Card title="Block Storage" href="/services/dashboard/user-guide/volumes" color="#bf9667">
