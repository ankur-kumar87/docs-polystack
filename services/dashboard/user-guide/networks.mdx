...
description: "Create and configure virtual networks, subnets, routers, and floating IPs through the Polystack Dashboard."
...
<CardGroup cols={2}>
  ...
  <Card title="DNS" href="/services/dns/user-guide" color="#bf9667">
