...
description: "Manage SSH key pairs, security groups, and application credentials through the Polystack Dashboard."
...
<CardGroup cols={2}>
  ...
  <Card title="Manage IPs" href="/services/compute/manage-ips" color="#bf9667">
  ...
  <Card title="Key Manager" href="/services/key-manager/user-guide" color="#bf9667">
