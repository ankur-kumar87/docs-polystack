...
description: "Understand the Xloud Key Manager service topology — API layer, worker service, metadata database, secret store backends, and CA plugin integration."
