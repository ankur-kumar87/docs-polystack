...
Transport key rotation is managed through the deployment console service configuration. After
generating a new RSA key pair:

<Steps titleSize="h3">
  <Step title="Generate a new RSA key pair">
    Generate a new RSA key pair for the transport key in the deployment console Key Manager configuration.
  </Step>
