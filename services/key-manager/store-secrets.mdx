---
title: "Store Secrets"
description: "Create, retrieve, and manage secrets in Polystack Key Manager using the Dashboard or CLI."
...
Secrets are the fundamental resource in Polystack Key Manager. Each secret stores an
...
Polystack Key Manager supports six secret types. The type you select determines which
...
<iframe
  ...
  title="How to Create and Manage Secrets on Polystack"
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    ...
    Create secrets through the Polystack Dashboard with a form that adapts
...
<AccordionGroup>
  ...
  <Accordion title="Symmetric" icon="shield-halved">
...
<CardGroup cols={2}>
  <Card title="Containers" icon="layer-group" href="/services/key-manager/containers" color="#bf9667">
  ...
  <Card title="Troubleshooting" icon="wrench" href="/services/key-manager/troubleshooting" color="#bf9667">
