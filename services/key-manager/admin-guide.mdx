...
<Tabs>
  <Tab title="Web Console" icon="server">
    The Key Management service is enabled through the the deployment console Configuration panel:
...
<CardGroup cols={4}>
  <Card title="Architecture" icon="network-wired" href="/services/key-manager/architecture" color="#bf9667">
    Key Manager service topology — API, worker, metadata DB, and secret store backends
  </Card>
  <Card title="Backend Configuration" icon="database" href="/services/key-manager/backend-config" color="#bf9667">
    Configure simple crypto, PKCS#11 HSM, and KMIP secret store backends
  </Card>
  <Card title="Secret Stores" icon="vault" href="/services/key-manager/secret-stores" color="#bf9667">
    Manage multiple secret store backends and assign stores to projects
  </Card>
  <Card title="Transport Keys" icon="key" href="/services/key-manager/transport-keys" color="#bf9667">
    View and rotate the RSA transport key for client-side encryption
  </Card>
  <Card title="Quotas" icon="gauge" href="/services/key-manager/quotas" color="#bf9667">
    Set per-project limits for secrets, containers, orders, and CAs
  </Card>
  <Card title="Security" icon="shield" href="/services/key-manager/security" color="#bf9667">
    Protect master keys, audit secret access, and enforce network controls
  </Card>
  <Card title="Troubleshooting" icon="wrench" href="/services/key-manager/admin-troubleshooting" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Key Manager User Guide" icon="book-open" href="/services/key-manager/user-guide" color="#bf9667">
    Step-by-step instructions for managing secrets, containers, and ACLs
  </Card>
  <Card title="Load Balancer Admin Guide" icon="shield-halved" href="/services/load-balancer/admin-guide" color="#bf9667">
  ...
  <Card title="Object Storage Admin Guide" icon="box" href="/services/object-storage/admin-guide" color="#bf9667">
