...
description: "Administer Xloud Key Manager — configure secret store backends, manage transport keys, enforce quotas, apply security hardening, and troubleshoot platform."
