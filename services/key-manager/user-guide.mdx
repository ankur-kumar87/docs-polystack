...
<CardGroup cols={4}>
  ...
  <Card title="Containers" icon="package" href="/services/key-manager/containers" color="#bf9667">
    Group related secrets into named bundles — certificate, RSA, and generic types
  </Card>
  <Card title="Certificates" icon="badge-check" href="/services/key-manager/certificates" color="#bf9667">
    Store externally issued TLS certificates or order new ones through a CA plugin
  </Card>
  <Card title="Access Control (ACL)" icon="list-checks" href="/services/key-manager/acl" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Key Manager Admin Guide" icon="shield-check" href="/services/key-manager/admin-guide" color="#bf9667">
