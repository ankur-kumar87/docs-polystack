...
description: "Manage secrets, containers, certificates, and ACLs in Polystack Key Manager. Securely store credentials, private keys, and TLS certificates for your cloud."
...
Polystack Key Manager provides a centralized, encrypted store for secrets, certificates,
...
<CardGroup cols={4}>
  <Card title="Store Secrets" icon="vault" href="/services/key-manager/store-secrets" color="#bf9667">
    Store passwords, API tokens, private keys, and binary payloads with type metadata
  </Card>
  <Card title="Containers" icon="box" href="/services/key-manager/containers" color="#bf9667">
    Group related secrets into named bundles — certificate, RSA, and generic types
  </Card>
  <Card title="Certificates" icon="circle-check" href="/services/key-manager/certificates" color="#bf9667">
    Store externally issued TLS certificates or order new ones through a CA plugin
  </Card>
  <Card title="Access Control (ACL)" icon="list-check" href="/services/key-manager/acl" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Key Manager Admin Guide" icon="shield-halved" href="/services/key-manager/admin-guide" color="#bf9667">
  ...
  <Card title="DNS User Guide" icon="globe" href="/services/dns/user-guide" color="#bf9667">
