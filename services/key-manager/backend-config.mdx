...
The active backend is visible in the the deployment console configuration panel under **Key Manager → Secret Store**. Verify the API is operational:
...
<Tabs>
  <Tab title="Simple Crypto" icon="microchip">
...
```bash title="Deploy Key Manager configuration via the deployment console"
