...
<CardGroup cols={2}>
  <Card title="Store Secrets Guide" href="/services/key-manager/store-secrets" color="#bf9667">
    Guide to storing and retrieving secrets securely
  </Card>
  <Card title="Certificates Guide" href="/services/key-manager/certificates" color="#bf9667">
