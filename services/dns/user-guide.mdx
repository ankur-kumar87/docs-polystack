...
<CardGroup cols={4}>
  ...
  <Card title="Reverse DNS" icon="arrow-left-right" href="/services/dns/reverse-dns" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="DNS Admin Guide" icon="shield-check" href="/services/dns/admin-guide" color="#bf9667">
