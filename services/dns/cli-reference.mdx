...
description: "Complete openstack zone and recordset CLI commands for managing Polystack DNS — zones, records, PTR records, and zone transfers."
...
<CardGroup cols={2}>
  <Card title="Create Zone Guide" href="/services/dns/create-zone" color="#bf9667">
    Step-by-step guide to creating DNS zones and records
  </Card>
  <Card title="Reverse DNS Guide" href="/services/dns/reverse-dns" color="#bf9667">
