...
description: "Understand the Polystack DNS service topology — API layer, central processing service, DNS worker, and backend nameserver pools with data plane separation."
sidebarTitle: "Architecture"
---

## Overview

The Polystack DNS service uses a multi-tier architecture separating the API layer, the
...
services managed by the deployment console. For production deployments:
...
<CardGroup cols={2}>
  ...
  <Card title="Troubleshooting" href="/services/dns/admin-troubleshooting" color="#bf9667">
