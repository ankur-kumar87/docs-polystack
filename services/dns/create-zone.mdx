...
description: "Provision authoritative DNS zones in Polystack DNS using the Dashboard or CLI. Configure primary and secondary zone types with TTL, email, and master server."
...
<iframe
  ...
  title="How to Create DNS Zones and Record Sets on Polystack"
...
given domain (e.g., `example.com.`). Creating a zone in Polystack DNS registers that domain
  ...
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Select the zone type">
        ...
        | Type | Description |
        |------|-------------|
        | **Primary** | Controlled by Polystack DNS — you manage the records directly |
