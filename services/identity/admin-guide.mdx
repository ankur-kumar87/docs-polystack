...
<CardGroup cols={4}>
  <Card title="Architecture" icon="network-wired" href="/services/identity/architecture" color="#bf9667">
...
<CardGroup cols={4}>
  ...
  <Card title="Compute Admin Guide" icon="gear" href="/services/compute/admin-guide" color="#bf9667">
