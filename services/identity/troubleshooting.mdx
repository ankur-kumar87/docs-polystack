...
description: "Diagnose and resolve authentication failures, permission errors, token scope issues, and application credential problems in Polystack Identity."
sidebarTitle: "Troubleshooting"
---

## Overview

This guide covers the most common issues encountered when working with Polystack Identity —
...
<AccordionGroup>
  ...
  <Accordion title="MFA code rejected" icon="mobile">
...
<AccordionGroup>
  <Accordion title="Permission denied on resource operation" icon="shield-halved">
...
<AccordionGroup>
  <Accordion title="Token scope error — resource not visible" icon="eye-slash">
...
<CardGroup cols={2}>
  <Card title="Identity Admin Guide — Troubleshooting" href="/services/identity/admin-troubleshooting" color="#bf9667">
