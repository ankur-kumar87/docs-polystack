...
description: "Create custom roles, assign them to users and groups on projects or domains, and build role hierarchies with implied roles in Xloud Identity."
sidebarTitle: "Roles"
---
...
<iframe
  ...
  title="How to Manage RBAC Permissions on Xloud Dashboard"
...
```yaml title="/etc/xavs/nova/policy.yaml"
