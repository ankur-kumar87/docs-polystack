...
description: "Enforce MFA, rotate Fernet keys, audit role assignments, and apply security best practices for Xloud Identity."
...
```yaml title="/etc/xavs/keystone/policy.yaml — enforce MFA for admin token issuance"
