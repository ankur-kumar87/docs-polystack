...
<CardGroup cols={2}>
  ...
  <Card title="Rotate Fernet Keys" icon="rotate-right" color="#bf9667">
    Schedule automated key rotation every 24 hours. the deployment console includes a cron-based rotation
  ...
  <Card title="Audit Role Assignments" icon="magnifying-glass" color="#bf9667">
...
<Steps titleSize="h3">
  ...
  <Step title="Configure automated rotation" icon="rotate-right">
    ```yaml title="the deployment console globals: automated Fernet rotation"
...
<AccordionGroup>
  <Accordion title="Restrict Identity API access" icon="network-wired" defaultOpen>
  ...
  <Accordion title="TLS configuration" icon="shield">
    ...
    ```yaml title="the deployment console globals: TLS configuration"
