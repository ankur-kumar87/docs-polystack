...
<CardGroup cols={4}>
  <Card title="Create a Network" icon="network-wired" href="/services/networking/create-network" color="#bf9667">
    Provision an isolated project network and configure its IP address space with a subnet
  </Card>
  <Card title="Create and Manage Subnets" icon="layer-group" href="/services/networking/subnets" color="#bf9667">
  ...
  <Card title="Network Topologies" icon="table-cells-large" href="/services/networking/network-topology" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Networking Admin Guide" icon="gear" href="/services/networking/admin-guide" color="#bf9667">
