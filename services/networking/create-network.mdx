...
description: "Provision an isolated tenant network and subnet in Polystack. Configure IP space, DHCP, DNS, and port security using the Dashboard or CLI."
...
Every project in Polystack Networking starts with a network — an isolated Layer 2 broadcast
