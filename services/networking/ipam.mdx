...
<Tabs>
  <Tab title="Dashboard" icon="desktop">
    <Steps titleSize="h3">
      <Step title="Pre-configure the network range in IPAM" icon="gear">
...
<AccordionGroup>
  <Accordion title="Port creation fails with 'IPAM driver error'" icon="triangle-exclamation">
  ...
  <Accordion title="IP not released after port deletion" icon="circle-xmark">
