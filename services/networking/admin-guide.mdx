...
<Tabs>
  <Tab title="Web Console" icon="server">
    Network configuration is managed through the the deployment console Configuration panel:
...
<CardGroup cols={4}>
  <Card title="Service Architecture" icon="network" href="/services/networking/architecture" color="#bf9667">
    Distributed SDN agent model — API server, message bus, L2/L3 agents, DHCP, and metadata
  </Card>
  <Card title="Provider Networks" icon="layers" href="/services/networking/provider-networks" color="#bf9667">
