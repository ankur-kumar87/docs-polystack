...
<AccordionGroup>
  ...
  <Accordion title="VXLAN tunnel failures between compute nodes" icon="layer-group">
  ...
  <Accordion title="MTU mismatch causing application-level failures" icon="arrows-split-up-and-left">
  ...
  <Accordion title="HA router not recovering after L3 agent failure" icon="route">
    ...
    **Resolution**:
    ...
    <Tip>
      ...
      timers in the deployment console if faster failover is required.
    </Tip>
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card title="User Troubleshooting" href="/services/networking/troubleshooting" color="#bf9667">
