...
Polystack Networking supports two advanced router modes for production deployments: High
...
graph LR
    ...
    style L3_1 fill:#d7b98e,color:#fff
```
...
<Info>
  HA routers require at least two L3 agents running in the cluster. Polystack Networking
...
<Tabs>
  <Tab title="XDeploy" icon="rocket">
    ...
    Click **Save and Deploy**. XDeploy applies the configuration via ironcore-ansible.
