...
description: "Design and visualize multi-tier network topologies in Polystack Cloud Platform. Reference architectures for web, app, and database tier isolation with SDN."
sidebarTitle: "Network Topologies"
---

## Overview

Polystack Networking's SDN fabric supports a wide range of topology patterns — from a single
...
graph TD
    ...
    W1 -.->|Floating IP| EXT
    W2 -.->|Floating IP| EXT
    style R fill:#bf9667,color:#fff
    style EXT fill:#d7b98e,color:#fff
```
...
graph TD
    ...
    style CORE_R fill:#bf9667,color:#fff
    style EXT fill:#d7b98e,color:#fff
```
...
graph TD
    ...
    style HA_R fill:#bf9667,color:#fff
    style EXT fill:#d7b98e,color:#fff
    style LB fill:#d7b98e,color:#fff
```
