...
<Tabs>
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Check per-port security" icon="magnifying-glass">
        ```bash title="Check port security on specific port"
        openstack port show <port-id> -f json | grep port_security_enabled
        ```
      </Step>
      <Step title="Disable port security for network appliances (exceptional)" icon="gear">
...
<Tabs>
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Identify the permissive same-group rule" icon="magnifying-glass">
      ...
      <Step title="Remove the permissive rule" icon="trash">
