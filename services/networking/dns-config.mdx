...
<Tabs>
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Set DNS resolvers on a subnet" icon="gear">
...
<CardGroup cols={2}>
  <Card title="Create and Manage Subnets" href="/services/networking/subnets" color="#bf9667">
    Manage all subnet settings including DHCP, allocation pools, and host routes
  </Card>
  <Card title="Network Troubleshooting" href="/services/networking/troubleshooting" color="#bf9667">
    Diagnose DHCP and name resolution failures on your instances
  </Card>
  <Card title="Floating IP Addresses" href="/services/networking/floating-ips" color="#bf9667">
    Assign public IPs to instances with DNS-resolvable hostnames
  </Card>
  <Card title="Network Topologies" href="/services/networking/network-topology" color="#bf9667">
