...
description: "Add, configure, and manage subnets within Polystack tenant networks. Control DHCP, allocation pools, DNS, and host routes from the Dashboard or CLI."
...
<Note>
  **Prerequisites**
  - An existing Polystack tenant network (see [Create a Network](/services/networking/create-network))
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Configure CIDR and gateway" icon="gear">
        | Field | Description |
        |-------|-------------|
