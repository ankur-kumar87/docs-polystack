...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="settings" href="/services/networking/admin-guide" color="#bf9667">
  ...
  <Card title="Related Services" icon="layers" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="Software-Defined Networking" icon="network" href="/services/networking/architecture" color="#bf9667">
  ...
  <Card title="VLAN and VXLAN Segmentation" icon="layers" href="/services/networking/provider-networks" color="#bf9667">
