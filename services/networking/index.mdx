...
<CardGroup cols={3}>
  ...
  <Card title="Polystack Block Storage" icon="hard-drive" color="#197560">
    Persistent volumes that mount inside compute instances on your networks
  </Card>
  <Card title="Polystack Load Balancer" icon="scale" color="#197560">
  ...
  <Card title="Polystack High Availability" icon="heart-pulse" color="#197560">
