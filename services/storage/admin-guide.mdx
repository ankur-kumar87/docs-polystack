...
<Tabs>
  <Tab title="Web Console" icon="server">
    ...
    <Steps titleSize="h3">
      ...
      <Step title="Configure backups" icon="box-archive">
...
<Steps titleSize="h3">
  <Step title="Review the architecture" icon="diagram-project">
  ...
  <Step title="Create volume types" icon="layer-group">
  ...
  <Step title="Configure storage tiers" icon="layer-group">
  ...
  <Step title="Configure the backup service" icon="box-archive">
...
<CardGroup cols={4}>
  <Card title="Service Architecture" icon="diagram-project" href="/services/storage/architecture" color="#bf9667">
  ...
  <Card title="Volume Migration" icon="arrows-up-down-left-right" href="/services/storage/migration" color="#bf9667">
    Migrate volumes between backends for rebalancing or hardware retirement
  </Card>
  <Card title="Backup Configuration" icon="box-archive" href="/services/storage/backup-config" color="#bf9667">
