...
Third-party backup tools integrate with Polystack through OpenStack-compatible APIs and snapshot
...
<CardGroup cols={2}>
  ...
  <Card title="Fleet-wide auto-discovery" icon="layer-group" color="#bf9667">
    The backup tool sees every VM through the OpenStack API. New VMs are picked up
...
<Steps titleSize="h3">
  ...
  <Step title="Allow OpenStack API access from the backup server" icon="network-wired">
