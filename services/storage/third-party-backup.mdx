...
<CardGroup cols={2}>
  ...
  <Card title="With Agent" icon="cpu" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Fleet-wide auto-discovery" icon="layers" color="#bf9667">
  ...
  <Card title="Snapshot-fast" icon="zap" color="#bf9667">
...
<Steps titleSize="h3">
  ...
  <Step title="Open Polystack APIs to the backup server" icon="network">
