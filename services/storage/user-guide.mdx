...
description: "Create, attach, snapshot, backup, and manage persistent block storage volumes in your Xloud project. Find guides for every volume lifecycle operation."
...
Xloud Block Storage provides persistent, high-performance block devices that attach to your
