...
<CardGroup cols={4}>
  ...
  <Card title="Volume Backups" icon="archive" href="/services/storage/backups" color="#bf9667">
  ...
  <Card title="Third-Party Backup" icon="shield-check" href="/services/storage/third-party-backup" color="#bf9667">
    Use Trilio, Veeam, Commvault, and other vendors alongside the native backup
  </Card>
  <Card title="Volume Transfers" icon="send" href="/services/storage/volume-transfers" color="#bf9667">
    Move volume ownership between projects using a token-based transfer
  </Card>
  <Card title="Volume Types" icon="layers" href="/services/storage/volume-types" color="#bf9667">
