...
<AccordionGroup>
  <Accordion title="Standard QoS Keys (all backends)" icon="gear" defaultOpen>
  ...
  <Accordion title="Pure Storage QoS Keys" icon="bolt">
    | Key | Unit | Description |
    |-----|------|-------------|
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Define the spec" icon="gear">
...
<Tabs>
  ...
  <Tab title="Size-Scaled QoS" icon="arrow-trend-up">
...
<Tabs>
  <Tab title="Polystack Dashboard (Monitoring)" icon="activity">
...
<CardGroup cols={2}>
  <Card title="Align with Volume Types" icon="layer-group" color="#bf9667">
  ...
  <Card title="Set Burst at 2x Sustained" icon="gauge" color="#bf9667">
  ...
  <Card title="Use Size-Scaled for Databases" icon="database" color="#bf9667">
  ...
  <Card title="Monitor Before Limiting" icon="activity" color="#bf9667">
    Baseline actual workload IOPS using Monitoring before applying QoS limits. Setting limits
...
Polystack provides pre-defined tiered QoS profiles that align with common workload classes. Each profile sets per-instance IOPS limits, bandwidth caps, and burst allowances with separate read and write thresholds.
...
<CardGroup cols={2}>
  ...
  <Card title="Block Storage Architecture" href="/services/storage/architecture" color="#bf9667">
