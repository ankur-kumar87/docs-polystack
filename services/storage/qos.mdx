...
<Tabs>
  <Tab title="Polystack Dashboard (XIMP)" icon="activity">
    Navigate to **Monitoring → Storage → Volume Metrics** in Polystack XIMP. Per-volume IOPS and throughput graphs show whether volumes are hitting their QoS limits:
