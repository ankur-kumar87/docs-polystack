...
description: "Increase the capacity of an Polystack Block Storage volume online or offline. Covers resizing the block device and expanding the filesystem after extension."
...
<Tabs>
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Check current size" icon="magnifying-glass">
...
<Tabs>
  ...
  <Tab title="LVM (logical volume)" icon="layer-group">
...
<AccordionGroup>
  <Accordion title="Extension fails with 'Invalid volume: Volume status must be available or in-use'" icon="triangle-exclamation">
  ...
  <Accordion title="resize2fs reports 'No space left on device'" icon="circle-xmark">
