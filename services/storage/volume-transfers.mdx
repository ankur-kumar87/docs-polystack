...
description: "Transfer ownership of Polystack Block Storage volumes between projects using a token-based mechanism. No data is copied — ownership changes instantly."
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Create transfer" icon="paper-plane">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Create transfer request" icon="paper-plane">
