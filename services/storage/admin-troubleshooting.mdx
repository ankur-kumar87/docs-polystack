...
<Note>
  **Before troubleshooting**
  ...
  - For critical production issues, contact [Polystack Support](mailto:support@polystack.tech)
...
<CardGroup cols={2}>
  ...
  <Card title="Contact Support" href="mailto:support@polystack.tech" color="#bf9667">
