...
<AccordionGroup>
  ...
  <Accordion title="LVM — configure thin pools" icon="layer-group">
  ...
  <Accordion title="Pure Storage — thin by default" icon="bolt">
...
<Tabs>
  <Tab title="Dashboard" icon="desktop">
    ...
    For provisioned-vs-physical overcommit visibility, use the Monitoring monitoring dashboard to track Cinder backend pool utilization over time.
  </Tab>
