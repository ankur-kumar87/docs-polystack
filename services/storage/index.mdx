...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="settings" href="/services/storage/admin-guide" color="#bf9667">
  ...
  <Card title="Software-Defined-Storage Product Page" icon="external-link" href="https://polystack.tech/ceph" color="#bf9667">
...
<CardGroup cols={3}>
  ...
  <Card title="Polystack Networking" icon="network" color="#bf9667">
