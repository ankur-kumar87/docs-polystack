...
<CardGroup cols={2}>
  ...
  <Card title="Software-Defined-Storage Product Page" icon="external-link" href="https://polystack.tech/ceph" color="#197560">
...
<CardGroup cols={3}>
  ...
  <Card title="Polystack Networking" icon="network" color="#197560">
    Virtual networks and floating IPs used alongside compute and storage resources
  </Card>
  <Card title="Polystack Distributed Storage" icon="database" href="https://polystack.tech/ceph" color="#197560">
