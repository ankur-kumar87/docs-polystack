...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Modify quotas" icon="pen-to-square">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      <Step title="Update storage quotas for a project" icon="pen-to-square">
...
<CardGroup cols={2}>
  ...
  <Card title="Security Hardening" href="/services/storage/security" color="#bf9667">
  ...
  <Card title="Troubleshooting (Admin)" href="/services/storage/admin-troubleshooting" color="#bf9667">
