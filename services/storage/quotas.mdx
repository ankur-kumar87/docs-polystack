...
description: "Configure and manage Xloud Block Storage quotas per project. Set global defaults, override per-project limits, and monitor quota usage across your deployment."
