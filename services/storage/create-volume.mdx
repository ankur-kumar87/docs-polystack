...
description: "Provision persistent block storage volumes in your Xloud project. Choose a data source, storage tier, and capacity using the Dashboard or CLI."
