...
<Steps titleSize="h3">
  <Step title="Find your snapshot" icon="magnifying-glass">
...
<AccordionGroup>
  ...
  <Accordion title="Find a file when you do not know the partition" icon="magnifying-glass">
...
<CardGroup cols={3}>
  ...
  <Card title="Storage Troubleshooting" href="/services/storage/troubleshooting" color="#bf9667">
