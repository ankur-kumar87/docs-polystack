...
<Tabs>
  <Tab title="Web Console" icon="package">
    <Steps titleSize="h3">
      <Step title="Open Storage Tiers in the deployment console" icon="layers">
...
<Steps titleSize="h3">
  ...
  <Step title="Configure a new backend in the deployment console" icon="settings">
