...
<Tabs>
  <Tab title="Web Console" icon="box">
    <Steps titleSize="h3">
      <Step title="Open Storage Tiers in the deployment console" icon="layer-group">
        Log in to the deployment console and navigate to **Configuration → Storage → Storage Tiers**.
        the deployment console displays the detected hardware device classes from the storage cluster.
      </Step>
      <Step title="Configure tier mappings" icon="gear">
...
<Steps titleSize="h3">
  ...
  <Step title="Configure a new backend in the deployment console" icon="gear">
    Add a new backend entry in the deployment console pointing to the new pool. Deploy the configuration
...
<CardGroup cols={2}>
  ...
  <Card title="Migration" href="/services/storage/migration" color="#bf9667">
