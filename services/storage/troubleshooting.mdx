...
<Note>
  **Before troubleshooting**
  ...
  - For persistent or recurring issues, contact [Polystack Support](mailto:support@polystack.tech)
...
<CardGroup cols={2}>
  <Card title="Contact Support" icon="headset" href="mailto:support@polystack.tech" color="#bf9667">
