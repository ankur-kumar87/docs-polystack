...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Create backup" icon="box-archive">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Create a full backup" icon="box-archive">
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Create incremental backup" icon="layer-group">
        Click the **More** dropdown and select **Data Protection > Create Backup** on the target volume.
...
<Tabs>
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Restore to a new volume" icon="rotate-left">
...
<CardGroup cols={2}>
  ...
  <Card title="Backup Configuration (Admin)" href="/services/storage/backup-config" color="#bf9667">
  ...
  <Card title="Quota Management (Admin)" href="/services/storage/quotas" color="#bf9667">
