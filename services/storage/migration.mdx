...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Locate the volume" icon="magnifying-glass">
        Navigate to
        **Storage > Volumes** (admin view). Use the search or filter to find the target volume.
      </Step>
      <Step title="Initiate migration" icon="arrows-up-down-left-right">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Check source volume location" icon="magnifying-glass">
...
<Steps titleSize="h3">
  ...
  <Step title="Migrate all volumes" icon="arrows-up-down-left-right">
...
<AccordionGroup>
  <Accordion title="Migration stuck in 'migrating' status" icon="clock">
    ...
    **Resolution**:
    ...
    Check volume service logs on the source and destination nodes via the deployment console for
