...
description: "Understand Polystack Block Storage volume types, storage performance tiers, and how to select the right tier for your workload requirements."
...
Polystack Block Storage supports tiered storage configurations. Each tier corresponds to a
...
<AccordionGroup>
  ...
  <Accordion title="Archival and Bulk Storage" icon="box-archive">
...
<Note>
  Encrypted volume types require the Polystack Key Management service to be accessible.
...
<CardGroup cols={2}>
  ...
  <Card title="Storage Tiers (Admin)" href="/services/storage/storage-tiers" color="#bf9667">
    Configure NVMe, SSD, and HDD tier mappings for your storage cluster
  </Card>
  <Card title="Encryption (Admin)" href="/services/storage/encryption" color="#bf9667">
