...
description: "Harden Xloud Block Storage with volume type access controls, minimum volume size policies, snapshot visibility management, and audit logging configuration."
