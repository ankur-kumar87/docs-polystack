...
description: "Create, restore, and manage point-in-time snapshots of Xloud Block Storage volumes. Use snapshots for fast recovery, volume cloning, and pre-change checkpoints."
