...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Retrieve the VIP port" icon="network-wired">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      <Step title="Retrieve the VIP port ID" icon="magnifying-glass">
...
<Tabs>
  ...
  <Tab title="External DNS" icon="network-wired">
...
<CardGroup cols={2}>
  ...
  <Card title="Polystack DNS" href="/services/dns" color="#bf9667">
    Create DNS records pointing to your load balancer floating IP.
  </Card>
  <Card title="Polystack Key Manager" href="/services/key-manager" color="#bf9667">
