...
<Steps titleSize="h3">
  <Step title="Assign a dedicated management network" icon="network-wired">
...
<AccordionGroup>
  <Accordion title="Management network isolated" icon="network-wired" defaultOpen>
  ...
  <Accordion title="Access logs forwarded" icon="file-lines">
