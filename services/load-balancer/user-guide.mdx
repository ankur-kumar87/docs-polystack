...
<CardGroup cols={4}>
  <Card title="Create a Load Balancer" icon="circle-plus" href="/services/load-balancer/create-lb" color="#bf9667">
    Provision a new load balancer with a listener, pool, and health monitor in a single workflow.
  </Card>
  <Card title="Listeners" icon="ear-listen" href="/services/load-balancer/listeners" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Load Balancer Admin Guide" icon="gear" href="/services/load-balancer/admin-guide" color="#bf9667">
