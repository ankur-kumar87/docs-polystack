...
description: "Add and configure HTTP, HTTPS, TCP, and UDP listeners on Polystack Load Balancers for multi-protocol traffic handling."
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Configure the listener" icon="gear">
        | Field | Description |
        |-------|-------------|
        ...
        | **Default TLS Container** | For TERMINATED_HTTPS — select the certificate from Polystack Key Manager |
      </Step>
