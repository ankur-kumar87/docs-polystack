...
description: "Monitor Polystack Load Balancer appliance health, connection statistics, and service component status for platform observability."
...
<Tabs>
  <Tab title="Load balancer statistics" icon="chart-bar">
  ...
  <Tab title="Listener statistics" icon="ear-listen">
...
Polystack Load Balancer exposes metrics via the Octavia Prometheus exporter when configured.
