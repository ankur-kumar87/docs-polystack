...
description: "Provision a new Polystack Load Balancer with a listener, pool, members, and health monitor in a single guided workflow."
...
Creating a load balancer in Polystack involves provisioning the top-level resource with a
...
<Steps titleSize="h3">
  ...
  <Step title="Configure load balancer details" icon="gear">
  ...
  <Step title="Add a listener" icon="ear-listen">
...
<Steps titleSize="h3">
  ...
  <Step title="Create a listener" icon="ear-listen">
...
<CardGroup cols={2}>
  <Card title="Floating IP Assignment" href="/services/load-balancer/floating-ip" color="#bf9667">
