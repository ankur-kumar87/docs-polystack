...
<CardGroup cols={2}>
  <Card title="Create Load Balancer Guide" href="/services/load-balancer/create-lb" color="#bf9667">
    End-to-end walkthrough for creating a load balancer
  </Card>
  <Card title="Networking CLI" href="/services/networking/cli-reference" color="#bf9667">
