...
description: "Understand the Polystack Load Balancer controller-appliance topology, data plane routing, and management plane components."
...
The Polystack Load Balancer service uses a controller-appliance model. The controller manages
...
<AccordionGroup>
  <Accordion title="Data plane" icon="bolt" defaultOpen>
  ...
  <Accordion title="Management plane" icon="gear">
...
<AccordionGroup>
  <Accordion title="Management network sizing" icon="network-wired">
