  ...
  <Tab title="Web Console" icon="server">
    <Steps titleSize="h3">
      <Step title="Open the deployment console Configuration" icon="settings">
        Navigate to **the deployment console → Configuration** and select the **Advance Features** tab.
      </Step>
      ...
      <Step title="Set certificate manager type" icon="key">
        Open **the deployment console → Advanced Configuration**, select **magnum** in the Service Tree,
      ...
      <Step title="Deploy the changes" icon="rocket">
        Navigate to **the deployment console → Operations** and run a **Reconfigure** for the
...
<CardGroup cols={2}>
  ...
  <Card title="Cluster Upgrades (User)" href="/services/kubernetes/user-guide/cluster-upgrades" color="#bf9667">
