...
<AccordionGroup>
  <Accordion title="Clusters fail to create across projects" icon="circle-xmark">
  ...
  <Accordion title="Heat stack in FAILED state" icon="layer-group">
  ...
  <Accordion title="DELETE_FAILED — cluster cannot be removed" icon="trash">
  ...
  <Accordion title="Conductor not processing cluster tasks" icon="microchip">
