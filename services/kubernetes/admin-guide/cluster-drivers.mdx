  ...
  <Tab title="Web Console" icon="server">
    <Steps titleSize="h3">
      <Step title="Open Advanced Configuration" icon="gear">
        Navigate to **the deployment console → Advanced Configuration** and select **magnum** in the
        Service Tree.
      </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Architecture" href="/services/kubernetes/admin-guide/architecture" color="#bf9667">
