...
description: "Manage Xloud K8SaaS per-project cluster quotas — set cluster count limits, monitor usage, and coordinate with compute quotas for node capacity planning."
sidebarTitle: "Quotas"
---
