...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Prepare workloads" icon="shield-halved">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      <Step title="Identify nodes to remove" icon="magnifying-glass">
...
<CardGroup cols={2}>
  <Card title="Maintain Minimum Replicas" icon="layer-group" color="#bf9667">
