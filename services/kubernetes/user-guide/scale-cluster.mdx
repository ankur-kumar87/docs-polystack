...
description: "Scale Xloud K8SaaS cluster node counts up or down — resize the default node group, monitor scale progress, and apply best practices for safe scale-down."
