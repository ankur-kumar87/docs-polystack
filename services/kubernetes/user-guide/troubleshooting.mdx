...
<AccordionGroup>
  ...
  <Accordion title="kubectl connection refused or timeout" icon="network-wired">
  ...
  <Accordion title="Nodes in NotReady state" icon="circle-exclamation">
  ...
  <Accordion title="Cluster upgrade fails mid-way" icon="circle-xmark">
  ...
  <Accordion title="Persistent volume claims not binding" icon="hard-drive">
    ...
    **Resolution**:
    ...
    template. Contact your administrator to update the platform template. Your administrator can configure this through the deployment console.
  </Accordion>
