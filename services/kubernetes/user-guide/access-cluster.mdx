...
description: "Download kubeconfig, configure kubectl, and verify access to your Polystack K8SaaS cluster — connect to the API server and validate node readiness."
...
and the cluster's kubeconfig file. Polystack K8SaaS generates a unique certificate authority
...
<Tabs>
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Set kubeconfig path" icon="gear">
