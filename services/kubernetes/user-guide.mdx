...
<CardGroup cols={4}>
  ...
  <Card title="Node Groups" icon="layer-group" href="/services/kubernetes/user-guide/node-groups" color="#bf9667">
    Create specialized node groups with different flavors, labels, and taints for
    workload-specific node pools.
  </Card>
  <Card title="Cluster Upgrades" icon="circle-arrow-up" href="/services/kubernetes/user-guide/cluster-upgrades" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="K8SaaS Admin Guide" icon="shield-halved" href="/services/kubernetes/admin-guide" color="#bf9667">
