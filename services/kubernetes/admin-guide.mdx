...
<CardGroup cols={4}>
  <Card title="Architecture" icon="layer-group" href="/services/kubernetes/admin-guide/architecture" color="#bf9667">
  ...
  <Card title="Network Drivers" icon="network-wired" href="/services/kubernetes/admin-guide/network-drivers" color="#bf9667">
...
<CardGroup cols={4}>
  ...
  <Card title="K8SaaS Overview" icon="layer-group" href="/services/kubernetes/index" color="#bf9667">
