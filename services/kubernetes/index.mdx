...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="shield-check" href="/services/kubernetes/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Node-Group Clusters" icon="layers" href="/services/kubernetes/user-guide/node-groups" color="#bf9667">
  ...
  <Card title="Network Plugin Choice" icon="network" href="/services/kubernetes/admin-guide/network-drivers" color="#bf9667">
