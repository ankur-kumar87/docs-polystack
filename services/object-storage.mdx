...
<Card title="Polystack Object Storage — Scale-Out Storage" icon="box" href="https://polystack.tech/ironcore" color="#bf9667" horizontal>
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="shield-check" href="/services/object-storage/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Built-In Redundancy" icon="shield-check" href="/services/object-storage/replication" color="#bf9667">
  ...
  <Card title="Large Object Support" icon="file-archive" href="/services/object-storage/large-objects" color="#bf9667">
...
<CardGroup cols={3}>
  ...
  <Card title="Polystack Image Service" icon="layers" href="/services/compute" color="#bf9667">
