...
description: "Scalable, durable object storage for Xloud private cloud — store and retrieve data at any scale with container-based organization, ACL controls, and large."
icon: "box"
