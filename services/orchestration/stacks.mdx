---
title: "Manage Stacks"
description: "Create, update, suspend, resume, and delete Polystack Orchestration stacks. Covers stack outputs, nested stacks, and update behavior through the Dashboard and CLI."
sidebarTitle: "Stacks"
---

## Overview

Polystack Orchestration manages the complete lifecycle of infrastructure stacks. After initial
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Open the stack" icon="layer-group">
...
`Polystack::Orchestration::Stack` resource type. Nesting enables modular template design
