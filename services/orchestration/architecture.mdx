...
graph TD
    ...
    GRAPH -->|Provision resource| COMPUTE[OpenStack Compute API<br/>:8774]
    GRAPH -->|Provision resource| NET[OpenStack Networking API<br/>:9696]
    GRAPH -->|Provision resource| STORE[OpenStack Block Storage API<br/>:8776]
    GRAPH -->|Provision resource| ID[OpenStack Identity API<br/>:5000]
