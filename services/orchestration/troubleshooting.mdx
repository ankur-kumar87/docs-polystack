...
<AccordionGroup>
  <Accordion title="Stack stuck in CREATE_FAILED" icon="circle-xmark">
  ...
  <Accordion title="Stack stuck in CREATE_IN_PROGRESS or UPDATE_IN_PROGRESS" icon="clock">
    ...
    **Common causes and resolutions**:
    ...
    | Instance in BUILD state for too long | Check compute host capacity and scheduler logs via the deployment console |
  ...
  <Accordion title="Template validation errors" icon="file">
  ...
  <Accordion title="Nested stack errors" icon="layer-group">
...
<CardGroup cols={2}>
  <Card title="Getting Started" href="/services/orchestration/getting-started" color="#bf9667">
  ...
  <Card title="Resource Types" href="/services/orchestration/resources" color="#bf9667">
