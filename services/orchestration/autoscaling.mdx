---
title: "Auto-Scaling with Heat Orchestration"
...
Heat Orchestration provides native auto-scaling through three coordinated resource types: a
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Manually trigger scale-out" icon="arrow-trend-up">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Trigger scale-out manually" icon="arrow-trend-up">
      ...
      <Step title="Check current group size" icon="chart-bar">
...
<AccordionGroup>
  <Accordion title="Stack fails to create with CREATE_FAILED" icon="circle-xmark">
  ...
  <Accordion title="Auto-scaling group does not grow beyond min_size" icon="arrow-trend-up">
