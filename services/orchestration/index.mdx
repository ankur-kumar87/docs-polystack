---
title: "Orchestration"
description: "Template-based infrastructure orchestration for Xloud Cloud Platform. Define, deploy, and manage cloud resources as code using declarative orchestration."
icon: "workflow"
