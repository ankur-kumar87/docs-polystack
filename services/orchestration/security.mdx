...
graph TD
    ...
    style TRUST fill:#bf9667,color:#fff
    style DU fill:#bf9667,color:#fff
```
...
Policies are applied via the deployment console configuration overrides in
...
<Tip>
  For multi-tenant environments, configure `allowed_resources` in the deployment console to restrict
...
<CardGroup cols={2}>
  ...
  <Card title="Polystack Identity" href="/services/identity/index" color="#bf9667">
