...
description: "Secure the Xloud Orchestration service — stack domain users, trust-based authorization, policy configuration, and template injection prevention."
...
Xloud Orchestration uses Xloud Identity <Tooltip tip="A trust allows one user (trustor) to delegate a subset of their roles to another entity (trustee) for a specific project.">trusts</Tooltip>
...
<CardGroup cols={2}>
  ...
  <Card title="Xloud Identity" href="/services/identity/index" color="#197560">
