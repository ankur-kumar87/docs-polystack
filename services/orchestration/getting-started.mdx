...
description: "Learn how to define an orchestration template, deploy a stack on Polystack, and manage the stack lifecycle using the Dashboard and CLI."
...
is the fundamental unit of Polystack Orchestration. You describe the desired infrastructure
...
<Note>
  **Prerequisites**
  ...
  - At least one image available in the Polystack Image Service
  - At least one flavor available for your project
  - A network available in your project
  - `polystack` CLI installed and authenticated (see [CLI Setup](/cli-setup))
</Note>
...
polystack_template_version: "2025-10-15"
