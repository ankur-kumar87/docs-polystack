...
<CardGroup cols={4}>
  <Card title="Architecture" icon="network" href="/services/images/architecture" color="#bf9667">
  ...
  <Card title="Image Import" icon="cloud-download" href="/services/images/image-import" color="#bf9667">
  ...
  <Card title="Image Cache" icon="zap" href="/services/images/image-cache" color="#bf9667">
