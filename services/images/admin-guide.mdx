...
<CardGroup cols={4}>
  <Card title="Architecture" icon="network-wired" href="/services/images/architecture" color="#bf9667">
    Service topology, storage backend options, and data flow for the Image Service.
  </Card>
  <Card title="Storage Backends" icon="database" href="/services/images/storage-backends" color="#bf9667">
    Configure Polystack Distributed Storage (RBD), file store, or object storage as the image backend.
  </Card>
  <Card title="Image Import" icon="cloud-arrow-down" href="/services/images/image-import" color="#bf9667">
    Use the web-download and chunked upload import APIs for large-scale image ingestion.
  </Card>
  <Card title="Metadata Definitions" icon="tag" href="/services/images/metadata" color="#bf9667">
    Define structured metadata namespaces for consistent image property schemas.
  </Card>
  <Card title="Image Cache" icon="bolt" href="/services/images/image-cache" color="#bf9667">
    Configure per-node image caching to reduce instance launch times.
  </Card>
  <Card title="Quotas" icon="gauge" href="/services/images/quotas" color="#bf9667">
    Enforce per-project image count and storage size limits.
  </Card>
  <Card title="Security" icon="shield" href="/services/images/image-security" color="#bf9667">
    Configure image signing, property protections, and public image access controls.
  </Card>
  <Card title="Troubleshooting" icon="wrench" href="/services/images/admin-troubleshooting" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Image User Guide" icon="book-open" href="/services/images/user-guide" color="#bf9667">
