...
graph TD
    ...
    style G1 fill:#bf9667,color:#fff
    style G2 fill:#bf9667,color:#fff
    style REG fill:#bf9667,color:#fff
    style STORE fill:#bf9667,color:#fff
```
...
<AccordionGroup>
  ...
  <Accordion title="File store limitations" icon="circle-xmark">
