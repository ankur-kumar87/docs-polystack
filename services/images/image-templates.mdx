...
description: "Use Polystack images as VM templates, manage image catalogs, share community images, export images, and track versions across projects."
...
An image in Polystack serves as more than a boot disk — it is the authoritative template for instance provisioning. A well-managed image catalog ensures consistent deployments, enforces approved operating system versions, and supports multi-project sharing with access control. This guide covers using images as templates, organizing a catalog, publishing community images, exporting images for external use, and managing versions.
...
Polystack Image Service does not enforce versioning natively — version tracking is implemented through naming conventions and image properties. The recommended approach:
...
<CardGroup cols={2}>
  ...
  <Card title="Image Security" href="/services/images/image-security" color="#bf9667">
    Sign images and enforce signature verification at launch time
  </Card>
  <Card title="Upload Image" href="/services/images/upload-image" color="#bf9667">
