...
description: "Configure per-project image count and storage size limits to prevent catalog storage exhaustion in Polystack."
sidebarTitle: "Quotas"
---
...
The Polystack Image Service enforces per-project quotas on image count and total storage size.
...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Navigate to project quota settings" icon="gear">
