...
description: "Define structured metadata namespaces for consistent, validated image property schemas across your Polystack image catalog."
...
| **Resource type** | The Polystack resource the namespace applies to — `OS::Image::Image` for images |
...
<Steps titleSize="h3">
  <Step title="Define the namespace schema" icon="file-code">
    ...
    {
      "namespace": "org.polystack.images",
      "display_name": "Polystack Image Properties",
      "description": "Standardized OS and hardware metadata for Polystack images",
      "visibility": "public",
      "protected": true,
      ...
      "properties": {
        ...
        "polystack_base_image": {
          "title": "Polystack Base Image",
          "description": "Whether this is an Polystack-maintained base image",
          "type": "boolean"
        },
  ...
  <Step title="Verify namespace is active" icon="circle-check">
    ...
    ```
    <Check>The `org.polystack.images` namespace appears in the list.</Check>
  </Step>
</Steps>
...
openstack metric namespace show org.polystack.images
```
```bash title="Delete a namespace"
openstack metric namespace delete org.polystack.images
```
</CodeGroup>
