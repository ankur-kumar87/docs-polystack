...
<Tabs>
  <Tab title="Ubuntu / Debian" icon="server">
    <Steps titleSize="h3">
      ...
      <Step title="Clean the cloud-init state" icon="trash">
  ...
  <Tab title="CentOS / AlmaLinux / Rocky Linux" icon="server">
    <Steps titleSize="h3">
      ...
      <Step title="Enable cloud-init services" icon="bolt">
...
<Steps titleSize="h3">
  <Step title="Configure DHCP on all interfaces" icon="network-wired">
...
<Tabs>
  <Tab title="GRUB 2 (most Linux distributions)" icon="terminal">
    <Steps titleSize="h3">
      <Step title="Edit GRUB default configuration" icon="pen-to-square">
        Edit `/etc/default/grub` and add the serial console parameters:
        ```text title="/etc/default/grub"
        GRUB_CMDLINE_LINUX="console=tty0 console=ttyS0,115200n8"
        ```
      </Step>
      <Step title="Regenerate GRUB configuration" icon="arrows-rotate">
...
<AccordionGroup>
  <Accordion title="Pre-upload checklist" icon="list-check" defaultOpen>
