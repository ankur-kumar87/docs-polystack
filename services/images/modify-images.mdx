...
<Steps titleSize="h3">
  ...
  <Step title="Install packages" icon="box">
...
<Steps titleSize="h3">
  ...
  <Step title="Edit a configuration file" icon="pen-to-square">
  ...
  <Step title="Copy files into the image" icon="file-import">
  ...
  <Step title="Exit and close" icon="right-from-bracket">
...
<Steps titleSize="h3">
  ...
  <Step title="Make modifications" icon="pen-to-square">
