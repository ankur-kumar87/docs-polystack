...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      <Step title="Open image details" icon="compact-disc">
  ...
  <Tab title="CLI" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Verify properties were applied" icon="magnifying-glass">
...
<AccordionGroup>
  <Accordion title="Modern Linux with UEFI boot" icon="gear" defaultOpen>
  ...
  <Accordion title="Windows Server with VirtIO drivers" icon="window-maximize">
...
<CardGroup cols={2}>
  <Card title="Image Formats" href="/services/images/image-formats" color="#bf9667">
  ...
  <Card title="Image Admin Guide — Metadata" href="/services/images/metadata" color="#bf9667">
