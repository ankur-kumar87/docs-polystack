...
<CardGroup cols={3}>
  <Card title="Image Catalog" icon="layers" href="/services/images/get-images" color="#bf9667">
  ...
  <Card title="Image Sharing" icon="share-2" href="/services/images/share-images" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="settings" href="/services/images/admin-guide" color="#bf9667">
    Configure storage backends, metadata schemas, image signing, caching, and quotas
    for production image service deployments.
  </Card>
  <Card title="Compute User Guide" icon="monitor" href="/services/compute/user-guide" color="#bf9667">
