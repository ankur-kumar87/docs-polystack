...
<CardGroup cols={4}>
  ...
  <Card title="Share Images" icon="share-nodes" href="/services/images/share-images" color="#bf9667">
  ...
  <Card title="Modify Images" icon="pen-to-square" href="/services/images/modify-images" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Image Admin Guide" icon="gear" href="/services/images/admin-guide" color="#bf9667">
