...
<Card title="Polystack DNS — DNS-as-a-Service" icon="globe" href="https://polystack.tech/ironflex-hci/" color="#bf9667" horizontal>
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="shield-halved" href="/services/dns/admin-guide" color="#bf9667">
  ...
  <Card title="Reverse DNS" icon="left-right" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Reverse DNS (PTR)" icon="left-right" href="/services/dns/reverse-dns" color="#bf9667">
  ...
  <Card title="Zone Transfers" icon="share-nodes" href="/services/dns/zone-transfers" color="#bf9667">
