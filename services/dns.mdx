---
title: "DNS Service"
description: "Manage DNS zones and records for your Polystack private cloud with Polystack DNS — authoritative DNS-as-a-service for zones, record sets, and reverse DNS."
icon: "globe"
sidebarTitle: "DNS"
mode: "wide"
---
...
<Card title="Polystack DNS — DNS-as-a-Service" icon="globe" href="https://polystack.tech/ironcore" color="#bf9667" horizontal>
  Product details and datasheet on polystack.tech
</Card>

---

<p style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.75rem' }}>Polystack DNS Service</p>

<CardGroup cols={2}>
  <Card title="User Guide" icon="book-open" href="/services/dns/user-guide" color="#bf9667">
    Create DNS zones, manage record sets (A, AAAA, CNAME, MX, TXT), configure reverse DNS, and query your DNS infrastructure.
  </Card>
  <Card title="Admin Guide" icon="shield-check" href="/services/dns/admin-guide" color="#bf9667">
  ...
  <Card title="CLI Reference" icon="terminal" href="/services/dns/cli-reference" color="#bf9667">
    `openstack zone` and `openstack recordset` commands for managing DNS from the command line.
  </Card>
  <Card title="Reverse DNS" icon="arrow-left-right" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="Authoritative DNS Zones" icon="map-pin" href="/services/dns/create-zone" color="#bf9667">
  ...
  <Card title="Multi-Record Support" icon="list" href="/services/dns/record-types" color="#bf9667">
  ...
  <Card title="Reverse DNS (PTR)" icon="arrow-left-right" href="/services/dns/reverse-dns" color="#bf9667">
  ...
  <Card title="TTL Management" icon="clock" href="/services/dns/manage-records" color="#bf9667">
  ...
  <Card title="API-Driven Automation" icon="code" href="/services/dns/cli-reference" color="#bf9667">
...
|-----------|-------------|
| Zone | An authoritative DNS domain (e.g., `example.com.`) managed by the Polystack DNS service |
...
<CardGroup cols={3}>
  ...
  <Card title="Polystack Networking" icon="network" href="/services/compute" color="#bf9667">
