...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="shield-check" href="/services/optimization/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="Intelligent Workload Consolidation" icon="layers" href="/services/optimization/user-guide/run-audit" color="#bf9667">
  ...
  <Card title="Energy Efficiency" icon="zap" href="/services/optimization/user-guide/optimization-goals" color="#bf9667">
