...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Open an audit" icon="magnifying-glass-plus">
...
<AccordionGroup>
  ...
  <Accordion title="Frequent noisy-neighbor audits" icon="volume-xmark">
  ...
  <Accordion title="Plans generated but never executed" icon="circle-pause">
