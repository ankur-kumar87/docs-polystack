...
description: "Resolve common Polystack Optimization issues — empty action plans, stuck audits, failed migrations, and cancelled action plans."
...
<AccordionGroup>
  ...
  <Accordion title="Audit stuck in ONGOING state" icon="clock">
    ...
    **Resolution**:
    ...
    to check Decision Engine and data source connectivity. Your administrator can configure this through the deployment console.
  ...
  <Accordion title="Action fails with migration error" icon="circle-xmark">
  ...
  <Accordion title="Action plan shows CANCELLED state" icon="circle-xmark">
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Troubleshooting" href="/services/optimization/admin-guide/troubleshooting" color="#bf9667">
