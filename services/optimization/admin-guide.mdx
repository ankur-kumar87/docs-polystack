...
<CardGroup cols={4}>
  <Card title="Architecture" icon="layers" href="/services/optimization/admin-guide/architecture" color="#bf9667">
  ...
  <Card title="Action Policies" icon="shield-check" href="/services/optimization/admin-guide/action-policies" color="#bf9667">
