...
<Tip>
  **the deployment console GUI** — Dynamic cluster optimization can be enabled through the the deployment console interface under the **Advance Features** tab by toggling **Enable Dynamic Cluster Optimization**. No manual file editing required.
</Tip>
