...
<Tabs>
  <Tab title="Dashboard" icon="gauge">
    <Steps titleSize="h3">
      ...
      <Step title="Restrict to service project" icon="folder">
...
<Tabs>
  <Tab title="Web Console" icon="window-maximize">
    <Steps titleSize="h3">
      <Step title="Automatic Credential Management" icon="shield-halved">
        Service account credentials and authentication settings are **automatically managed**
        by the deployment console during deployment. the deployment console generates the `[keystone_authtoken]` section
      ...
      <Step title="Custom Authentication Settings (Optional)" icon="gear">
      ...
      <Step title="Save and Apply" icon="circle-check">
        ...
        <Check>Service credentials configured and applied via the deployment console.</Check>
      </Step>
    </Steps>
  </Tab>
  <Tab title="CLI" icon="terminal">
