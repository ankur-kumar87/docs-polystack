...
description: "Configure Xloud Compute for Optimization compatibility — verify shared storage, live migration capability, and host state for optimization action execution."
  ...
  <Tab title="XDeploy" icon="browser">
    <Steps titleSize="h3">
      ...
      <Step title="Edit the Compute Configuration" icon="file-pen">
        ...
        ```ini title="/etc/xavs/config/nova/nova.conf"
        [libvirt]
        cpu_mode = custom
