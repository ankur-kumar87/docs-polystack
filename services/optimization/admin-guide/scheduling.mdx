  ...
  <Tab title="Web Console" icon="window-maximize">
    <Steps titleSize="h3">
      ...
      <Step title="Save and Apply" icon="circle-check">
        ...
        <Check>Action plan expiry configured and applied via the deployment console.</Check>
      </Step>
    </Steps>
  </Tab>
  <Tab title="CLI" icon="terminal">
...
<CardGroup cols={2}>
  <Card title="Action Plan Policies" href="/services/optimization/admin-guide/action-policies" color="#bf9667">
  ...
  <Card title="Audit History (User)" href="/services/optimization/user-guide/audit-history" color="#bf9667">
