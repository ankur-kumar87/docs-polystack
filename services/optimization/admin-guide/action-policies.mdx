...
<CardGroup cols={2}>
  <Card title="Manual Approval (Default)" icon="eye" color="#bf9667">
  ...
  <Card title="Automatic Execution" icon="play" color="#bf9667">
  ...
  <Tab title="Web Console" icon="window-maximize">
    <Steps titleSize="h3">
      ...
      <Step title="Save and Apply" icon="circle-check">
        ...
        <Check>Action plan expiry policy configured and applied via the deployment console.</Check>
      </Step>
    </Steps>
  </Tab>
