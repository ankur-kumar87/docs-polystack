...
description: "Configure Xloud Optimization action plan execution policies — manual approval workflows, automatic execution for trusted strategies, and plan expiry controls."
...
<Tabs>
  ...
  <Tab title="CLI" icon="terminal">
    ...
    ```ini title="/etc/xavs/watcher/watcher.conf"
    [DEFAULT]
    action_plan_expiry = 24
    ```
