...
<AccordionGroup>
  ...
  <Accordion title="Ring inconsistency between nodes" icon="code-branch">
  ...
  <Accordion title="High quarantine count on a specific node" icon="shield-halved">
...
<CardGroup cols={2}>
  <Card title="Object Storage Troubleshooting (User)" href="/services/object-storage/troubleshooting" color="#bf9667">
