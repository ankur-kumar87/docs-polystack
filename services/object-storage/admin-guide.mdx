...
<CardGroup cols={4}>
  <Card title="Architecture" icon="network-wired" href="/services/object-storage/architecture" color="#bf9667">
    Cluster topology — proxy tier, storage tier, and consistent hash ring mechanics
  </Card>
  <Card title="Storage Policies" icon="layer-group" href="/services/object-storage/storage-policies" color="#bf9667">
    Design and manage data placement tiers using named storage policies
  </Card>
  <Card title="Ring Management" icon="arrows-rotate" href="/services/object-storage/ring-management" color="#bf9667">
...
<CardGroup cols={4}>
  ...
  <Card title="Load Balancer Admin Guide" icon="object-group" href="/services/load-balancer/admin-guide" color="#bf9667">
