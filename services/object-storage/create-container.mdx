...
description: "Provision object storage containers in Xloud Object Storage using the Dashboard or CLI. Configure container name, access policy, and storage policy."
