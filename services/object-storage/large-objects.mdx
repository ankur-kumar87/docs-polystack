...
description: "Upload files larger than 5 GB in Polystack Object Storage using Static Large Objects (SLO) or Dynamic Large Objects (DLO) for multi-part segment management."
...
Individual objects in Polystack Object Storage are limited to 5 GB per upload request.
