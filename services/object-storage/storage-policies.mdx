...
<AccordionGroup>
  <Accordion title="Rclone — universal multi-cloud sync" icon="arrows-rotate">
  ...
  <Accordion title="Glance integration — image backend" icon="compact-disc">
...
```bash title="Deprecate a policy via the deployment console configuration"
# In the the deployment console Object Storage configuration:
...
<CardGroup cols={2}>
  <Card title="Plan Policies Before Deployment" icon="map" color="#bf9667">
  ...
  <Card title="Use EC for Archival Data" icon="shield" color="#bf9667">
  ...
  <Card title="Tag Rings by Device Class" icon="tag" color="#bf9667">
  ...
  <Card title="Set Sensible Defaults" icon="gear" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Architecture" href="/services/object-storage/architecture" color="#bf9667">
