...
description: "Upload, download, list, update, and delete objects in Xloud Object Storage containers using the Dashboard and CLI. Includes metadata and bulk operations."
