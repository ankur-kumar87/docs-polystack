...
<CardGroup cols={4}>
  ...
  <Card title="Access Control" icon="list-check" href="/services/object-storage/access-control" color="#bf9667">
  ...
  <Card title="Large Objects" icon="file-zipper" href="/services/object-storage/large-objects" color="#bf9667">
...
<CardGroup cols={4}>
  <Card title="Object Storage Admin Guide" icon="shield-halved" href="/services/object-storage/admin-guide" color="#bf9667">
