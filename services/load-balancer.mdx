...
<Card title="Polystack Load Balancer — Enterprise LBaaS" icon="combine" href="https://polystack.tech/ironcore" color="#bf9667" horizontal>
...
<CardGroup cols={2}>
  ...
  <Card title="Admin Guide" icon="shield-check" href="/services/load-balancer/admin-guide" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="Layer 4 & Layer 7 Balancing" icon="layers" href="/services/load-balancer/listeners" color="#bf9667">
  ...
  <Card title="Multiple Algorithms" icon="git-branch" href="/services/load-balancer/pools" color="#bf9667">
