...
<CardGroup cols={2}>
  <Card title="Ansible Integration" href="/integrations/ansible" color="#197560">
    Combine Terraform provisioning with Ansible for post-provision configuration management
  </Card>
  <Card title="Auto-Scaling with Orchestration" href="/services/orchestration/autoscaling" color="#197560">
    Deploy auto-scaling stacks via Terraform and wire Prometheus alerts for dynamic scaling
  </Card>
  <Card title="Block Storage" href="/services/storage/create-volume" color="#197560">
