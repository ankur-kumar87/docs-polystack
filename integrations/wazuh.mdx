...
description: "Deploy Wazuh agents on Xloud instances for real-time threat detection, file integrity monitoring, log collection, vulnerability scanning, and centralized SIEM visibility."
sidebarTitle: "Wazuh"
---
