...
<Tabs>
  <Tab title="Linux (Ubuntu/Debian)" icon="terminal">
    <Steps titleSize="h3">
      ...
      <Step title="Install the agent" icon="package">
...
<AccordionGroup>
  <Accordion title="Agent shows Disconnected in Wazuh Dashboard" icon="wifi-off">
  ...
  <Accordion title="Bulk deployment fails on some instances" icon="circle-x">
