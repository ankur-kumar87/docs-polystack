...
<CardGroup cols={2}>
  <Card title="Verify" icon="shield-check" color="#bf9667">
  ...
  <Card title="Remove" icon="trash" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="Bootstrap" icon="check" href="/deployment/bootstrap" color="#bf9667">
