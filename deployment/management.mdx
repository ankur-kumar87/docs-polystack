...
<CardGroup cols={2}>
  <Card title="Individual Accounts" icon="users" color="#bf9667">
  ...
  <Card title="Strong Passwords" icon="lock" color="#bf9667">
  ...
  <Card title="Scale Gradually" icon="trending-up" color="#bf9667">
  ...
  <Card title="Maintenance Windows" icon="clock" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Dashboard User Guide" icon="monitor" href="/services/dashboard/user-guide" color="#bf9667">
