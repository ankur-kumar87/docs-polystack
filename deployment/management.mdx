...
<Tabs>
  <Tab title="User Management" icon="users">
    ...
    <Info>
      Every account created through this interface receives the **admin** and **heat_stack_owner** roles automatically. These roles grant full access to all projects, users, and orchestration capabilities. For restricted user accounts with limited roles, use the [Xloud Dashboard](/services/dashboard/user-guide) identity management panel after deployment.
    </Info>
  </Tab>
