...
<CardGroup cols={3}>
  ...
  <Card title="Networking CLI" icon="network" href="/services/networking/cli-reference" color="#bf9667">
  ...
  <Card title="Orchestration CLI" icon="layers" href="/services/orchestration/cli-reference" color="#bf9667">
  ...
  <Card title="Load Balancer CLI" icon="combine" href="/services/load-balancer/cli-reference" color="#bf9667">
  ...
  <Card title="Kubernetes CLI" icon="container" href="/services/kubernetes/cli-reference" color="#bf9667">
