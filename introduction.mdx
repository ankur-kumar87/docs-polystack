...
<Tabs>
  ...
  <Tab title="Operations" icon="activity">
    <CardGroup cols={2}>
      <Card title="Monitoring — Infrastructure Monitoring" icon="activity" href="/products/monitoring" color="#197560">
        End-to-end monitoring, APM, log management, and security
      </Card>
      <Card title="Disaster Recovery" icon="rotate-ccw" href="/products/disaster-recovery" color="#197560">
