---
title: "Lynis"
description: "Run Lynis security audits on Xloud virtual machines and host nodes to detect misconfigurations, hardening gaps, and compliance deviations with remediation guidance."
sidebarTitle: "Lynis"
---
...
<Info>**Xloud-Developed** — Lynis is one of three independent scanners in [Xloud SIEM](/security/xloud-siem) — Wazuh, Lynis, and OpenSCAP run in parallel across all nodes for layered compliance coverage. Results are aggregated on the **Security Posture** page in Monitor Center.</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="OpenSCAP" href="/security/openscap" color="#197560">
