---
title: "Data Security"
description: "Encrypt block volumes with LUKS, protect object storage at rest and in transit, manage encryption keys with Xloud Key Management, and configure secure deletion."
...
<Tip>Key rotation requires migrating the volume. Schedule rotations during maintenance windows. Xloud Key Management retains old keys until explicitly deleted to support rollback scenarios.</Tip>
...
<CardGroup cols={2}>
  <Card title="Key Manager Service" href="/services/key-manager/store-secrets" color="#197560">
    Detailed guide for storing and managing secrets in Xloud Key Management
  </Card>
  <Card title="Volume Encryption (Admin)" href="/services/storage/encryption" color="#197560">
