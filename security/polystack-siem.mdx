...
<CardGroup cols={3}>
  <Card title="Wazuh (HIDS)" icon="shield-halved" href="/security/wazuh" color="#bf9667">
...
<AccordionGroup>
  ...
  <Accordion title="6. Microsegmentation" icon="network-wired">
...
<AccordionGroup>
  ...
  <Accordion title="Find out why one node's compliance score dropped" icon="arrow-trend-down">
  ...
  <Accordion title="Find high-risk security groups" icon="triangle-exclamation">
  ...
  <Accordion title="Export a snapshot for audit" icon="file-lines">
  ...
  <Accordion title="Investigate a live Wazuh alert" icon="magnifying-glass">
...
<CardGroup cols={2}>
  <Card title="Wazuh Deep Dive" icon="shield-halved" href="/security/wazuh" color="#bf9667">
    Architecture, agent deployment, ruleset, File Integrity Monitoring
  </Card>
  <Card title="Lynis Deep Dive" icon="list-check" href="/security/lynis" color="#bf9667">
