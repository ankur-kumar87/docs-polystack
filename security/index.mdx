...
<CardGroup cols={1}>
  <Card title="Polystack SIEM" icon="shield-alert" href="/security/polystack-siem" color="#bf9667">
...
<CardGroup cols={2}>
  ...
  <Card title="Hardening Guide" icon="shield-check" href="/security/hardening-guide" color="#bf9667">
...
<CardGroup cols={2}>
  <Card title="VM Security" icon="cpu" href="/security/vm-security" color="#bf9667">
    Hypervisor isolation, security groups, vTPM, encrypted volumes, Secure Boot, anti-affinity, and live migration TLS.
  </Card>
  <Card title="Network Security" icon="network" href="/security/network-security" color="#bf9667">
...
<Info>**Polystack-Developed** — This capability is developed by Polystack and ships with Ironcore.</Info>
...
<CardGroup cols={3}>
  ...
  <Card title="OS Hardening (CIS Benchmark)" icon="shield-check" color="#bf9667">
  ...
  <Card title="Security Operations Dashboard" icon="layout-dashboard" color="#bf9667">
  ...
  <Card title="Active Response" icon="shield-alert" color="#bf9667">
  ...
  <Card title="Custom Detection Rules" icon="scan-search" color="#bf9667">
  ...
  <Card title="SBOM CI Pipeline" icon="package-search" color="#bf9667">
...
<CardGroup cols={4}>
  ...
  <Card title="Hardening Checklist" icon="list-checks" href="/security/hardening-guide#checklist" color="#bf9667">
