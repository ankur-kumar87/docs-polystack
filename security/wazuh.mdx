---
title: "Wazuh"
description: "Deploy Wazuh agents across Xloud virtual machines for real-time threat detection, file integrity monitoring, vulnerability assessment, and compliance auditing."
sidebarTitle: "Wazuh"
---
...
<Info>**Xloud-Developed** — This capability is developed by Xloud and ships with XAVS. The integrated security platform is surfaced in the Xloud Dashboard as the **Security Posture** page in Monitor Center, providing a unified view of agent status, threat alerts, and compliance results across the cluster. See [Xloud SIEM](/security/xloud-siem) for the full overview.</Info>
...
<CardGroup cols={2}>
  <Card title="File Integrity Monitoring" icon="file-scan" color="#197560">
  ...
  <Card title="Intrusion Detection" icon="shield-alert" color="#197560">
  ...
  <Card title="Vulnerability Assessment" icon="bug" color="#197560">
  ...
  <Card title="Compliance Auditing" icon="clipboard-list" color="#197560">
...
<Tabs>
  <Tab title="Linux (Ansible)" icon="terminal">
    ...
    ```bash title="Deploy Wazuh agents via xavs-ansible"
...
<CardGroup cols={2}>
  ...
  <Card title="Lynis Security Auditing" href="/security/lynis" color="#197560">
    Run automated OS security audits and generate hardening recommendations
  </Card>
  <Card title="OpenSCAP Compliance Scanning" href="/security/openscap" color="#197560">
