...
description: "Configure audit logging, log aggregation, and retention for Xloud Platform. Map platform controls to SOC 2, ISO 27001, HIPAA, PCI-DSS, and GDPR frameworks."
...
```yaml title="/etc/xavs/globals.d/_60_audit.yml"
