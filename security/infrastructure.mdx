...
description: "Configure TLS for all Xloud platform services, manage certificates, harden service endpoints, and secure HAProxy termination for internal and external traffic."
...
<AccordionGroup>
  <Accordion title="Disable unused API versions" icon="code">
    ...
    ```yaml title="/etc/xavs/globals.d/_60_endpoint_hardening.yml"
