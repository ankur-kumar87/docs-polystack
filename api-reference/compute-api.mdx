...
description: "Polystack Compute API (Nova) overview, key endpoints, request/response examples, and common operations for managing virtual machine instances programmatically."
sidebarTitle: "Compute API"
---

## Overview

The Polystack Compute API provides programmatic control over virtual machine instances, flavors, keypairs, availability zones, server groups, and hypervisor resources. The API follows RESTful conventions with JSON request and response bodies.
