...
description: "Authenticate with the OpenStack API using password tokens, application credentials, and scoped tokens. Includes token lifecycle management and CLI examples."
