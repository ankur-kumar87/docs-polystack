...
<CardGroup cols={4}>
  ...
  <Card title="Networking API" icon="network" href="/api-reference/networking-api" color="#bf9667">
  ...
  <Card title="Automation" icon="workflow" href="/integrations/index" color="#bf9667">
